...
const organizationSchema = {
  ...
  description: 'We help tradespeople and small businesses in Bath & North East Somerset get found on Google. Website design, Google Business Profile, and getting you on the map.',
...
const websiteSchema = {
  ...
  url: siteUrl,
  name: 'SEO Kings',
  description: 'Get found on Google. Website design and Google Business Profile for tradespeople and small businesses in Bath & North East Somerset.',
...
const localBusinessSchema = {
  ...
  name: 'SEO Kings',
  description: 'We help tradespeople and small businesses in Bath & North East Somerset get found on Google. Website design, Google listing, and getting you on the map so you get more customers.',
  url: siteUrl,
  telephone: '+447702264921',
  image: `${siteUrl}/og-image.jpg`,
