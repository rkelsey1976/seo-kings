...
export const metadata = {
  title: { absolute: 'Website Designer Bradford-on-Avon, Wiltshire | From £250 | SEO Kings' },
  description: 'Website designer serving Bradford-on-Avon BA15, Wiltshire. Fast, mobile-first websites for trades and local businesses from £250. GBP optimisation from £100. Free audit — no obligation.',
