  ...
  const schemas = [
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'SEO', item: `${BASE_URL}/seo` },
        { '@type': 'ListItem', position: 3, name: 'Local SEO', item: `${BASE_URL}/local-seo` },
        { '@type': 'ListItem', position: 4, name: `Local SEO for ${trade.name}`, item: pageUrl },
      ],
    },
    {
      '@context': 'https://schema.org',
      '@type': 'Service',
      '@id': `${pageUrl}/#service`,
      name: `Local SEO for ${trade.name} in Bristol, and Bath & North East Somerset`,
    ...
    },
    {
      ...
      name: 'SEO Kings',
      description: `Local SEO for ${trade.name} in Bristol, and Bath & North East Somerset. We help ${trade.name.toLowerCase()} rank higher on Google and get more enquiries.`,
      url: pageUrl,
