...
export default function TradePageSchema({ slug }) {
  ...
  const schemas = [
    ...
    },
    {
      ...
      '@type': 'Service',
      '@id': `${pageUrl}/#service`,
      name: `Local SEO for ${trade.name} in Bath, Bristol & North East Somerset`,
    ...
    },
    {
      ...
      name: 'SEO Kings',
      description: `Local SEO for ${trade.name} in Bath, Bristol and North East Somerset. We help ${trade.name.toLowerCase()} rank higher on Google and get more enquiries.`,
      url: pageUrl,
