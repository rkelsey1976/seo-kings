...
export const metadata = {
  title: { absolute: 'Local SEO Bradford-on-Avon, Wiltshire | Map Pack from £150/month | SEO Kings' },
  description: 'We get Bradford-on-Avon trades and local businesses in Wiltshire into the Google map pack and ranking on page one. GBP optimisation, website SEO, review growth. From £150/month. Free audit — no obligation.',
