...
export const metadata = {
  ...
  description: 'How we build trade websites that rank on Google — fast, mobile-first, SEO-ready from day one. For plumbers, electricians, builders and local businesses across Bath & North East Somerset. From £250.',
