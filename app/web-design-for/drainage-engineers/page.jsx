...
export const metadata = {
  title: { absolute: 'Web Design for Drainage Engineers in Bath & Somerset | From £250 | SEO Kings' },
  description: 'Websites for drainage engineers in Bath that rank on Google. Emergency page, CCTV survey pages. From £250. SEO Kings.',
