...
export const metadata = {
  title: { absolute: 'Web Design for Gas Engineers in Bath & Somerset | From £399 | SEO Kings' },
  description: 'Websites for Gas Safe engineers in Bath that rank on Google. Gas Safe badge, emergency page, boiler pages. From £399. SEO Kings.',
