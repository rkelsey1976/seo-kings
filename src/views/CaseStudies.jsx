  ...
  const caseStudies = [
    ...
    },
    {
      ...
      results: [
        ...
        { metric: 'Top 3', label: 'Map Pack · "exterior painter Bath"' },
    ...
    },
    {
      ...
      logo: 'BP',
      image: 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=400&h=250&fit=crop&auto=format&q=80',
      imageAlt: 'Painter and decorator Bath - Bath Painter bespoke website design case study',
      challenge: 'Established painter and decorator with no website and no brand identity — invisible to customers searching online, despite 20+ years of experience with heritage and period properties across Bath.',
      solution: 'Complete brand and bespoke website package: logo, business cards, social media toolkit, and a full site at bathpainter.co.uk covering interior, exterior, heritage and commercial work.',
      results: [
    ...
    },
    {
      ...
      logo: 'AB',
      image: 'https://aspectbuilds.co.uk/images/hero-james-bath-property-4.webp',
      imageAlt: 'Builder and property maintenance Bath - Aspect Builds website design and local SEO case study',
      challenge: 'No website — just an Instagram page. A quality Bath builder with decades of experience was completely invisible on Google when people searched for builders, extensions, or loft conversions in Bath.',
      solution: 'Full 40-page website at aspectbuilds.co.uk with hub-and-spoke SEO architecture, real project photography, Schema markup, responsive images, YouTube video walkthrough, and Google Business Profile optimisation. Live in under two weeks.',
      results: [
        { metric: '40 pages', label: 'Live at aspectbuilds.co.uk' },
        { metric: '0 → 1', label: 'From Instagram to website' },
        { metric: '6 services', label: 'With dedicated pages' },
        { metric: '98+', label: 'Lighthouse accessibility' },
      ],
