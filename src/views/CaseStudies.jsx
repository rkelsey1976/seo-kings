...
const CaseStudies = () => {
  const caseStudies = [
    ...
    },
    {
      ...
      imageAlt: 'Painter and decorator Bath - Bath Painter website design case study in progress',
      challenge: 'Established painter and decorator with no dedicated website — missing out on customers searching online for decorating services across Bath and Keynsham.',
      solution: 'Full bespoke website in build covering interior, exterior and heritage property work. Designed to rank for painting and decorating searches across Bath, Keynsham and surrounding areas.',
      results: [
        { metric: 'In build', label: 'Bespoke website' },
        { metric: 'Heritage', label: 'Property specialists' },
        { metric: 'Coming soon', label: 'SEO & GBP' },
      ],
      timeframe: 'In progress',
      quote: 'Results incoming — site currently in build. Watch this space.',
      author: 'Bath Painter',
