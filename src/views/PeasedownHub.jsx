  ...
  '@graph': [
    {
      ...
      name: 'Digital Marketing in Peasedown St John | SEO & Local Search | SEO Kings',
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Fast, mobile-first websites for Peasedown St John trades and local businesses. See the full website design page for packages and pricing.
              </p>
