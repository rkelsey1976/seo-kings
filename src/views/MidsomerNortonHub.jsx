...
const schema = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      name: 'SEO Kings',
      description: 'Web design, local SEO and Google Business Profile agency serving Midsomer Norton BA3 and the Somer Valley. Fast, mobile-first websites from £399 and local SEO from £150/month for trades and local businesses across Midsomer Norton, Radstock and Bath.',
      url: 'https://seo-kings.co.uk/areas/midsomer-norton',
...
const MidsomerNortonHub = () => {
  return (
    <>
      <SEO
        title="Web Design & SEO in Midsomer Norton | Somer Valley Trades | SEO Kings"
        description="Web design, local SEO and Google Business Profile for trades and local businesses in Midsomer Norton BA3. Websites from £399, local SEO from £150/month. Free audit."
      ...
      <section
        ...
        style={{
          backgroundImage: 'url(/images/areas/midsomer-norton.webp)',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-base text-gray-400 leading-relaxed max-w-2xl mb-8">
              The Somer Valley is less competitive than Bath or Bristol — which means the right strategy gets you visible fast. Whether you need a website, local SEO, or both, we build everything around getting you found in BA3 and the surrounding area.
            </p>
          ...
          <div className="grid sm:grid-cols-2 gap-6 max-w-4xl">
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8">
              ...
              <div>
                ...
                <div className="text-gray-500 text-xs">Peachy Cleans · Cleaning, Midsomer Norton</div>
              </div>
            </div>
