...
const faqs = [
  {
    q: "What's the best starting point for a Frome business?",
    a: "Most Frome trades do best starting with a website and Google Business Profile together. BA11 is less competitive than Bath — your investment goes further and results come faster. We'll tell you exactly what to prioritise in your free audit.",
  },
  {
    q: 'Can I rank in Bath and Trowbridge as well as Frome?',
    a: 'Yes — many Frome traders serve both Somerset and Wiltshire. We structure your site and GBP to target multiple towns, so one plan covers your whole working area without extra cost.',
  },
  {
    q: 'How competitive is Frome for local search?',
    a: 'Less competitive than Bath. Most Frome trades have no website or a weak Google Business Profile — the bar to reach page one is lower here, and results come faster.',
  },
  {
    q: 'How long before I see results?',
    a: "GBP improvements can show within weeks. Organic rankings for Frome trade searches typically take 2–4 months. You'll get a monthly report so you can see exactly what's moving.",
  },
  {
    q: 'What does it cost?',
  ...
  '@graph': [
    {
      ...
      name: 'Web Design & SEO in Frome | SEO Kings',
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Frome' },
        ],
      },
    },
    {
      ...
      name: 'SEO Kings',
      description: 'Web design, local SEO and Google Business Profile agency serving Frome BA11 and the surrounding Somerset area. Fast, mobile-first websites from £250 and local SEO from £150/month for trades and local businesses across Frome, Bath and Radstock.',
      url: 'https://seo-kings.co.uk/areas/frome',
...
const FromeHub = () => {
  return (
    <>
      <SEO
        title="Web Design & SEO in Frome | Somerset Trades | SEO Kings"
        description="Web design, local SEO and Google Business Profile for trades and local businesses in Frome BA11. Websites from £250, local SEO from £150/month. Free audit — no obligation."
      ...
      <ServicePageHero
        ...
        highlight="Frome"
        description="Frome is one of Somerset's fastest-growing towns — creative, independent, full of trades. We make sure local customers find your business first on Google."
      ...
      <section className="py-24 bg-dark-lighter border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <SectionTag className="mb-4">Our services in Frome</SectionTag>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 leading-tight tracking-tight">
              Everything you need to get found in Frome
            </h2>
            <p className="text-gray-400 leading-relaxed max-w-2xl">
              Frome has grown rapidly but most local trades still have poor Google visibility. Three services, one team — website, local SEO and GBP all working together.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Fast, mobile-first websites for Frome trades and local businesses — built for local search from day one, not as an afterthought.
              </p>
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    'Mobile-first design, loads fast on any device',
                    'Built to rank for your trade + Frome searches',
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Frome has far less competition than Bath or Bristol. The businesses in the map pack take most of the calls — and getting there is more achievable here. We get you in and keep you there.
              </p>
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    'Google Business Profile optimisation',
                    'On-page SEO for Frome trade keywords',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              We&apos;re based in Keynsham — well placed to serve Frome and the whole BA11 area. Frome is one of Somerset&apos;s most interesting towns: growing fast, creative community, lots of independent trades. Most of those trades have poor Google visibility — and that&apos;s a real opportunity.
            </p>
            <p className="text-gray-400 leading-relaxed mb-8">
              We cover Frome and the surrounding area: Westbury, Shepton Mallet, Radstock, Midsomer Norton, Frome Valley and the wider Somerset and Wiltshire border. Many Frome clients also want to rank in Bath — we structure everything to cover your whole working area.
            </p>
            <a
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-white mb-10 leading-tight tracking-tight">Common questions about our Frome services</h2>
