...
const faqs = [
  {
    q: "What's the best starting point for a Timsbury business?",
    a: "For most trades, a website and Google Business Profile together give the strongest foundation. Timsbury is a rural, less competitive market — which means results come faster here than in Bath or Bristol. We'll tell you what to prioritise in your free audit.",
  },
  {
    q: 'Can I rank in Bath and Midsomer Norton as well as Timsbury?',
    a: "Yes — most Timsbury trades serve a wide area. We structure your site and GBP to target Timsbury, Bath and the Somer Valley from one plan, so you're visible across your whole working area.",
  },
  {
    q: 'How competitive is Timsbury for local search?',
    a: "Much less competitive than Bath or Bristol. Most local trades still have no website or a weak Google Business Profile — the bar is lower and results come faster. It's one of the easier markets we work in.",
  },
  {
    q: 'How long before I see results?',
    a: "GBP improvements can show within weeks. Organic rankings for Timsbury trade searches typically take 2–4 months. You'll get a monthly report so you see exactly what's moving.",
  },
  {
    q: 'What does it cost?',
...
const schema = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://seo-kings.co.uk/areas/timsbury',
      url: 'https://seo-kings.co.uk/areas/timsbury',
      name: 'Web Design & SEO in Timsbury | BA2 Trades & Businesses | SEO Kings',
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Timsbury' },
        ],
      },
    },
    {
      ...
      name: 'SEO Kings',
      description: 'Web design, local SEO and Google Business Profile agency serving Timsbury BA2 and the Somer Valley. Fast, mobile-first websites from £250 and local SEO from £150/month for trades and local businesses across Timsbury, Bath and Midsomer Norton.',
      url: 'https://seo-kings.co.uk/areas/timsbury',
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: 'url(/images/areas/timsbury.webp)',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6 leading-tight tracking-tight">
              Web Design &amp; SEO in{' '}
              <span className="text-primary">Timsbury</span>
            </h1>
            <p className="text-xl text-gray-400 leading-relaxed max-w-2xl mb-4">
              One team. Three services. All focused on getting your Timsbury business found on Google.
            </p>
            <p className="text-base text-gray-400 leading-relaxed max-w-2xl mb-8">
              Timsbury is a rural village sitting between Bath and Midsomer Norton — trades here serve a wide area and face far less competition than in either town. The right strategy gets you visible fast across the whole BA2 postcode and beyond. Whether you need a website, local SEO, or both, we build everything around getting you found.
            </p>
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <SectionTag className="mb-4">Our services in Timsbury</SectionTag>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 leading-tight tracking-tight">
              Everything you need to get found in Timsbury
            </h2>
            <p className="text-gray-400 leading-relaxed max-w-2xl">
              Three services, one team, clear monthly pricing. Most Timsbury clients combine website design and local SEO — and see results faster here than in Bath or Bristol thanks to lower competition in the BA2 area.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Fast, mobile-first websites for Timsbury trades and local businesses — built for local search from day one, not as an afterthought.
              </p>
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    'Mobile-first design, loads fast on any device',
                    'Built to rank for your trade + Timsbury searches',
              ...
              <div className="mt-auto">
                ...
                >
                  Website Design for Timsbury Businesses →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Timsbury has far less competition than Bath or Bristol. The businesses in the map pack take most of the calls — and getting there is more achievable here. We get you in and keep you there.
              </p>
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    'Google Business Profile optimisation',
                    'On-page SEO for Timsbury trade keywords',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              We&apos;re based in Keynsham — well placed to serve Timsbury and the whole BA2/Somer Valley area. We understand which trade searches drive enquiries in Timsbury and the surrounding villages, and how to build visibility across Bath and Midsomer Norton from a single strategy.
            </p>
            <p className="text-gray-400 leading-relaxed mb-8">
              We cover the whole of the BA2 area — Camerton, Paulton, High Littleton, Hallatrow, and the wider BA2 postcode. Many Timsbury clients also want to rank in Bath and Midsomer Norton — we can target multiple locations from one plan.
            </p>
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-white mb-10 leading-tight tracking-tight">Common questions about our Timsbury services</h2>
