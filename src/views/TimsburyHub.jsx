...
const schema = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      name: 'SEO Kings',
      description: 'Web design, local SEO and Google Business Profile agency serving Timsbury BA2 and the Somer Valley. Fast, mobile-first websites from £399 and local SEO from £150/month for trades and local businesses across Timsbury, Bath and Midsomer Norton.',
      url: 'https://seo-kings.co.uk/areas/timsbury',
