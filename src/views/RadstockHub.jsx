...
const faqs = [
  ...
  {
    q: 'What does it cost?',
    a: 'Website design from £399. Local SEO from £150/month — includes GBP optimisation, on-page fixes, citations and monthly reporting. Free audit first, no obligation.',
  },
];
  ...
  '@graph': [
    {
      ...
      name: 'Web Design & SEO in Radstock | Somer Valley Trades | SEO Kings',
    ...
    },
    {
      ...
      name: 'SEO Kings',
      description: 'Web design, local SEO and Google Business Profile agency serving Radstock BA3 and the Somer Valley. Fast, mobile-first websites from £399 and local SEO from £150/month for trades and local businesses across Radstock, Midsomer Norton and Bath.',
      url: 'https://seo-kings.co.uk/areas/radstock',
...
const RadstockHub = () => {
  return (
    <>
      <SEO
        title="Web Design & SEO in Radstock | Somer Valley Trades | SEO Kings"
        description="Web design, local SEO and Google Business Profile for trades and local businesses in Radstock BA3. Websites from £399, local SEO from £150/month. Free audit — no obligation."
      ...
      <section
        ...
        style={{
          backgroundImage: 'url(/images/areas/radstock.webp)',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6 leading-tight tracking-tight">
              Web Design &amp; SEO in{' '}
              <span style={{ color: '#E8715A' }}>Radstock</span>
            </h1>
            <p className="text-xl text-gray-400 leading-relaxed max-w-2xl mb-4">
              One team. Three services. All focused on getting your Radstock business found on Google.
            </p>
            <p className="text-base text-gray-400 leading-relaxed max-w-2xl mb-8">
              The Somer Valley is less competitive than Bath or Bristol — which means the right strategy gets you visible fast. Whether you need a website, local SEO, or both, we build everything around getting you found in BA3 and the surrounding Somer Valley.
            </p>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Fast, mobile-first websites for Radstock trades and local businesses — built for local search from day one, not as an afterthought.
              </p>
      ...
      <section className="py-20 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-10">Common questions about our Radstock services</h2>
