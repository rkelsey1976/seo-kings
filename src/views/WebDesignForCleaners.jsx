    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6 leading-tight tracking-tight">
              Web Design for{' '}
              <span className="text-primary">Cleaners</span>
              {' '}in Bath & Somerset
            </h1>
            ...
            <p className="text-lg text-gray-400 leading-relaxed max-w-2xl mb-8">
              We build websites for cleaning businesses in Bath, Keynsham, Midsomer Norton and across North East Somerset. We've already got a Midsomer Norton cleaner into the Google Map Pack. From £250.
            </p>
            ...
            <div className="flex flex-wrap gap-6 mt-10">
              {['From £250', 'DBS display included', 'Map Pack proven', '6 months free hosting', 'Live in under 2 weeks'].map((t) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl font-bold text-white mb-6 leading-tight tracking-tight">Built to build trust and win recurring customers</h2>
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="text-3xl font-bold text-white mb-10 leading-tight tracking-tight">We've already done it for a local cleaner</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <div className="space-y-4 mb-8">
              {[
                { name: 'Starter', desc: '1-page site — services, trust signals and contact', price: 'From £250' },
                { name: 'Professional', desc: '3-page site — home, 1 service page, contact', price: 'From £350' },
                { name: 'Full', desc: '5+ pages — home, domestic, end of tenancy, deep clean, service areas', price: 'From £450' },
              ].map((pkg) => (
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-6 leading-tight tracking-tight">We know the cleaning market in Bath & Somerset</h2>
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-white mb-10 leading-tight tracking-tight">Common questions about cleaning business websites</h2>
