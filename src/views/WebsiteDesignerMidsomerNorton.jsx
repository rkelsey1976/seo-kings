  ...
  '@graph': [
    {
      ...
      description: 'Website designer serving Midsomer Norton BA3. Fast, mobile-first websites for trades and local businesses from £250. GBP optimisation from £100.',
      inLanguage: 'en-GB',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-400 leading-relaxed max-w-2xl mb-8">
              We build fast, Google-ready websites for trades and local businesses in Midsomer Norton BA3. From £250. Add GBP optimisation for £100. Live in under 2 weeks.
            </p>
