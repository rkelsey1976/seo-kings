...
const faqs = [
  {
    q: 'How much does a website cost in Midsomer Norton?',
  ...
  {
    q: 'Do you work with businesses in Midsomer Norton?',
    a: "Yes. We're based nearby in Keynsham and regularly work with businesses across Midsomer Norton, Radstock, Paulton and the surrounding BA3 area.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes — that's the point. We built Peachy Cleans' site in Midsomer Norton and got them into the Google Map Pack for 'cleaning Midsomer Norton'. Every site we build is optimised for local search from day one.",
  },
  {
    q: 'What trades do you work with in Midsomer Norton?',
    a: 'Plumbers, electricians, builders, cleaners, painters — any trade that needs local customers in Midsomer Norton, Radstock, Paulton or the wider Somer Valley.',
  },
];
...
const schema = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://seo-kings.co.uk/website-designer-midsomer-norton',
      url: 'https://seo-kings.co.uk/website-designer-midsomer-norton',
      name: 'Website Designer Midsomer Norton | SEO Kings',
      description: 'Website designer serving Midsomer Norton BA3. Fast, mobile-first websites for trades and local businesses from £399. Google Business Profile included.',
      inLanguage: 'en-GB',
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Website Designer Midsomer Norton' },
        ],
      },
    },
    {
      ...
      name: 'SEO Kings',
      description: 'Website designer serving Midsomer Norton and the Somer Valley — web design from £399 for trades and local businesses across BA3, Bath and North East Somerset.',
      url: 'https://seo-kings.co.uk/website-designer-midsomer-norton',
...
const WebsiteDesignerMidsomerNorton = () => {
  return (
    <>
      <SEO
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-400 leading-relaxed max-w-2xl mb-8">
              We build fast, Google-ready websites for trades and local businesses in Midsomer Norton BA3. From £399 — with Google Business Profile set-up included. Live in under 2 weeks.
            </p>
            ...
            <div className="flex flex-wrap gap-6 mt-10">
              {[
                ...
                { label: 'Peachy Cleans — Map Pack proof' },
              ].map((t) => (
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 leading-tight">
                A website built to get you found in Midsomer Norton
              </h2>
              <p className="text-gray-400 leading-relaxed mb-8">
                Most website designers build pretty sites that don't rank. Every site we build is optimised for Google from the start — targeting the searches customers in Midsomer Norton and the Somer Valley actually use.
              </p>
...
export default WebsiteDesignerMidsomerNorton;
