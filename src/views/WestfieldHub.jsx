...
const faqs = [
  {
    q: "What's the best starting point for a Westfield business?",
    a: "For most trades, a website and Google Business Profile together give the strongest foundation. Westfield is part of the Somer Valley — less competitive than Bath or Bristol — so results come faster here. We'll tell you what to prioritise in your free audit.",
  },
  {
    q: 'Can I rank in Midsomer Norton and Bath as well as Westfield?',
    a: "Yes — Westfield trades typically serve Midsomer Norton, Radstock and Bath. We structure your site and GBP to target the whole area from one plan, so you're visible across your entire working patch.",
  },
  {
    q: 'How competitive is Westfield for local search?',
    a: "Less competitive than Bath or Bristol. Many local trades still have no website or a weak GBP — the bar to get on page one is lower here and results come faster.",
  },
  {
    q: 'How long before I see results?',
    a: "GBP improvements can show within weeks. Organic rankings for Westfield trade searches typically take 2–4 months. You'll get a monthly report so you see exactly what's moving.",
  },
  {
    q: 'What does it cost?',
  ...
  '@graph': [
    {
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Westfield' },
        ],
      },
    },
    {
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: 'url(/images/areas/westfield.webp)',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6 leading-tight tracking-tight">
              Web Design &amp; SEO in{' '}
              <span className="text-primary">Westfield</span>
            </h1>
            <p className="text-xl text-gray-400 leading-relaxed max-w-2xl mb-4">
              One team. Three services. All focused on getting your Westfield business found on Google.
            </p>
            <p className="text-base text-gray-400 leading-relaxed max-w-2xl mb-8">
              Westfield sits on the edge of Midsomer Norton in the heart of the Somer Valley — less competitive than Bath or Bristol, and many local trades want to rank across Midsomer Norton, Radstock and Bath from a single plan. Whether you need a website, local SEO, or both, we build everything around getting you found in BA3 and beyond.
            </p>
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <SectionTag className="mb-4">Our services in Westfield</SectionTag>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 leading-tight tracking-tight">
              Everything you need to get found in Westfield
            </h2>
            <p className="text-gray-400 leading-relaxed max-w-2xl">
              Three services, one team, clear monthly pricing. Most Westfield clients combine website design and local SEO — and see results faster here than in Bath or Bristol.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    ...
                    'Built to rank for your trade + Westfield searches',
              ...
              <div className="mt-auto">
                ...
                >
                  Website Design for Westfield Businesses →
                </Link>
              </div>
            </div>
              ...
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    ...
                    'On-page SEO for Westfield trade keywords',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              We&apos;re based in Keynsham — well placed to serve Westfield and the whole BA3 area. Westfield sits right on the edge of Midsomer Norton, and many local trades want to rank across Midsomer Norton, Radstock and Bath from a single plan. We know which trade searches drive enquiries here and how to build that visibility fast.
            </p>
            <p className="text-gray-400 leading-relaxed mb-8">
              We cover the whole area — Midsomer Norton, Radstock, Clandown, Peasedown St John, and the wider BA3 postcode.
            </p>
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-10 leading-tight tracking-tight">Common questions about our Westfield services</h2>
