...
const included = [
  ...
  'Built to rank for Bath, BA1 & BA2 trade searches',
  'Google Business Profile set-up — Map Pack rankings for Bath postcodes',
...
const faqs = [
  ...
  {
    q: 'Do you work with businesses in Bath?',
    a: "Yes — Bath is our home patch. We're based in Keynsham, around 8 miles from the city centre, and we work with trades and local businesses across BA1 and BA2 every week.",
  },
  {
  ...
  {
    q: 'Will my website show up on Google in Bath?',
    a: "That's the goal. Bath is competitive — there are well-established businesses here with decent websites. We build pages that are properly structured for local search, with the right signals for BA1 and BA2, so you give yourself a real shot at page one and the Map Pack.",
  },
  {
    q: 'What trades do you work with in Bath?',
    a: 'Plumbers, electricians, builders, cleaners, painters, decorators, landscapers — any trade that needs local customers in Bath, Batheaston, Bathampton, Combe Down, Odd Down or the wider BA postcode area.',
  },
  {
    q: 'Can you help me rank in the Google Map Pack in Bath?',
    a: 'Yes. Map Pack rankings depend on your Google Business Profile, your website, and your reviews. We optimise all three — and we have clients already in the Bath Map Pack for competitive trade keywords.',
  },
];
  ...
  '@graph': [
    {
      ...
      description: 'Website designer serving Bath BA1 & BA2. Fast, mobile-first websites for trades and local businesses from £250. GBP optimisation from £100.',
      inLanguage: 'en-GB',
    ...
    },
    {
      ...
      name: 'SEO Kings',
      description: 'Website designer serving Bath — web design from £250 for trades and local businesses across BA1, BA2 and surrounding areas.',
      url: 'https://seo-kings.co.uk/website-designer-bath',
  ...
  return (
    <>
      ...
      <ServicePageHero
        ...
        highlight="Bath"
        description="We build fast, Google-ready websites for trades and local businesses in Bath. From £250. Add GBP optimisation for £100. Live in under 2 weeks."
        features={[
          'From £250',
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed mb-8">
                Most website designers build pretty sites that don't rank. Every site we build is optimised for Google from the start — targeting the searches customers in Bath and across BA1 and BA2 actually use.
              </p>
      ...
      {/* Content expansion — Bath web design */}
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mb-12">
            <SectionTag className="mb-4">Why it works</SectionTag>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 leading-tight tracking-tight">
              Web design in Bath — what it actually takes to rank in a competitive city
            </h2>
            <p className="text-gray-400 leading-relaxed mb-4">
              Bath is one of the most searched local markets in the South West. "Plumber Bath", "builder Bath", "painter Bath" — there are thousands of searches every month, and the competition is real. You're up against established businesses with decent websites and years of Google history behind them.
            </p>
            <p className="text-gray-400 leading-relaxed mb-4">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              Location signals matter more in a competitive city. We don't just put "Bath" in your title tag and call it done. Every page we build references your specific service areas — BA1, BA2, Combe Down, Oldfield Park, Batheaston, Weston — in headings, body copy and structured data. That specificity is what separates a page that ranks from one that doesn't.
            </p>
            <p className="text-gray-400 leading-relaxed">
              We're based in Keynsham, 8 miles from Bath city centre. We know the market, we've worked with Bath trades, and we're easy to reach. When you need something changed, you call us directly — not a support ticket queue.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { title: 'Real Bath results', body: 'We have clients already in the Bath Map Pack for competitive trade keywords — not theory, live rankings.' },
              ...
              { title: 'BA1 & BA2 precision', body: 'Postcodes, village names and Bath districts woven into every page — not bolted on as an afterthought.' },
              { title: '8 miles away', body: 'Keynsham-based. Easy to reach, quick to respond — no account managers between you and us.' },
            ].map((card) => (
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-white mb-6 leading-tight tracking-tight">We know Bath</h2>
            <p className="text-gray-400 leading-relaxed mb-4">
              SEO Kings is based in Keynsham — 8 miles from Bath and well within the BA postcode area. Bath is our most active market. We've built sites for painters, decorators and builders in the city, and we have live Map Pack results to show for it. When we talk about what it takes to rank in Bath, it's from direct experience — not a template approach applied from a distance.
            </p>
            <p className="text-gray-400 leading-relaxed mb-8">
              We serve trades across Bath city centre, Bathwick, Oldfield Park, Combe Down, Weston, Larkhall, Batheaston, Bathampton, and the surrounding BA1 and BA2 areas. If you're a trade in Bath without a properly optimised website, you're leaving calls on the table every week.
            </p>
