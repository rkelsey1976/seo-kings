  ...
  '@graph': [
    {
      ...
      description: 'Websites for loft conversion companies in Bath & Somerset. Fast, mobile-first, built to rank for loft conversion searches. Before/after galleries, planning permission pages, Google Business Profile included. From £250.',
      inLanguage: 'en-GB',
    ...
    },
    {
      ...
      offers: {
        ...
        price: '399',
        priceCurrency: 'GBP',
        description: 'Loft conversion company website from £250 including Google Business Profile set-up',
      },
    },
    {
      '@type': 'LocalBusiness',
  ...
  return (
    <>
      <SEO
        ...
        description="Websites for loft conversion companies in Bath & Somerset. Fast, mobile-first, built for loft conversion searches. Before/after galleries, planning permission pages, Google Business Profile included. From £250."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-gray-400 leading-relaxed max-w-2xl mb-8">
              We build websites for loft conversion companies in Bath, Keynsham, Midsomer Norton and across North East Somerset — with before and after galleries, planning permission guides, and Google Business Profile optimisation as standard. From £250.
            </p>
            ...
            <div className="flex flex-wrap gap-6 mt-10">
              {['From £250', 'Before & after gallery', 'Planning permission guide', '6 months free hosting', 'Live in under 2 weeks'].map((t) => (
          ...
          <div className="max-w-2xl">
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                { name: 'Professional', desc: '3-page site — home, 1 conversion type page, contact', price: 'From £350' },
                { name: 'Full', desc: '5+ pages — home, conversion type pages, gallery, planning guide, about', price: 'From £450' },
              ].map((pkg) => (
