  ...
  '@graph': [
    {
      ...
      description: 'Websites for loft conversion companies in Bath & Somerset. Fast, mobile-first, built to rank for loft conversion searches. Before/after galleries, planning permission pages. From £250. Add GBP optimisation for £100.',
      inLanguage: 'en-GB',
    ...
    },
    {
      ...
      offers: {
        ...
        price: '250',
        priceCurrency: 'GBP',
        description: 'Loft conversion company website from £250 — GBP optimisation available as a £100 add-on',
      },
    },
    {
      '@type': 'LocalBusiness',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-gray-400 leading-relaxed max-w-2xl mb-8">
              We build websites for loft conversion companies in Bath, Keynsham, Midsomer Norton and across North East Somerset — with before and after galleries, planning permission guides, from £250. Add GBP optimisation for £100.
            </p>
