...
const WIKIPEDIA_BY_SLUG = {
  ...
  'bath-city-centre': 'https://en.wikipedia.org/wiki/Bath,_Somerset',
};
...
const AREA_GEO = {
  ...
  'bath-city-centre': { latitude: 51.3811, longitude: -2.3590 },
...
const AreaDetail = ({ params: staticParams }) => {
  ...
  const areasData = {
    'bath': {
      ...
      subAreaSlugs: ['bath-city-centre', 'odd-down-bath', 'combe-down-bath', 'widcombe-bath', 'larkhall-bath', 'twerton-bath', 'weston-bath', 'oldfield-park-bath', 'bear-flat-bath', 'bathampton-bath', 'bathwick-bath', 'southdown-bath', 'batheaston-bath', 'walcot-bath', 'bathford-bath'],
    ...
    'bath-city-centre': {
      ...
      postcodes: ['BA1'],
      heroImage: '/images/areas/bath-roman-baths.webp',
      metaTitle: 'Website Design Bath City Centre | Web Designer & SEO Add-ons – SEO Kings',
      metaDescription: 'Website design for Bath city centre businesses from £250 — independent shops, cafés, salons and professional services. Google Business Profile and local SEO add-ons. Free check.',
      heroHeadline: 'Website design in Bath city centre',
      heroSubhead: 'From £250. SEO add-ons so customers and visitors find your city-centre business first.',
      description: "Bath city centre is the commercial heart of the city — the BA1 core running from Bath Abbey and the Roman Baths through SouthGate, Stall Street and Union Street up to the Milsom Quarter, Queen Square and Kingsmead. It's one of the busiest retail and hospitality districts in the South West, packed with independent shops, cafés, restaurants, salons, galleries and professional-services offices, and it draws millions of visitors a year on top of its resident and working population. That footfall is an opportunity — but only if your business shows up when people search on their phones for somewhere to eat, shop or book while they're in town.",
      extendedDescription: "City-centre businesses compete for the same searches as every other Bath business, so a generic listing gets lost fast. We build a fast, mobile-first website and a properly optimised Google Business Profile so your shop, café, salon or office ranks for 'in Bath' and 'near me' searches — the ones visitors and locals actually make while standing in the centre. Whether you're an independent retailer on Milsom Street, a restaurant off Kingsmead Square, or a solicitor or accountant with an office near Queen Square, we get you found first rather than buried under the Bath-wide competition.",
      heroStats: [
        { value: 'Part of', label: 'Bath' },
        { value: 'BA1', label: 'Postcode' },
        { value: 'Top 3', label: 'Map Pack Positions Achieved' },
      ...
      ctaButtonText: 'Get Free Check – No Obligation',
      whyIntro: "The city centre is the most competitive patch in Bath — high footfall, high search volume, and a lot of businesses chasing the same customers. A fast website and a well-run Google Business Profile are what separate the businesses that get found from the ones that don't.",
      whyBullets: [
        { title: 'Built for footfall and phone searches', text: "Visitors and locals search 'café near me', 'salon in Bath', 'shop open now' on their phones in the centre. We make sure your business is what they find." },
        { title: 'Retail, hospitality and professional services', text: 'City-centre trade isn\'t just plumbers and electricians — it\'s shops, restaurants, salons, galleries and offices. We build sites that suit how those businesses actually get booked.' },
        { title: 'Google Business Profile done properly', text: 'For a city-centre business the map pack is everything. We set your listing up to win the local pack for BA1 searches, not just sit on page two.' },
        { title: 'Transparent pricing', text: 'From £250. No hidden fees, no long contracts.' },
      ],
      services: [
        { name: 'Website Design', description: 'Fast, mobile-friendly sites from £250. Our main service for Bath city-centre businesses.' },
        { name: 'Google Business Profile', description: 'Add-on: win the map pack for BA1 city-centre searches.' },
        { name: 'Local SEO', description: 'Add-on: rank for Bath city centre and trade or retail keywords.', href: '/local-seo/bath' },
      ],
      ...
      servicesLinkText: 'View All Services',
      keywordsHeading: 'Keywords We Target',
      keywordsIntro: 'We focus on what customers and visitors in Bath city centre search:',
      industries: ['Retail & Independent Shops', 'Hospitality', 'Health & Beauty', 'Professional Services'],
      landmarks: ['Bath Abbey', 'Roman Baths', 'SouthGate', 'Milsom Street', 'Pulteney Bridge', 'Kingsmead Square', 'Queen Square'],
      landmarksHeading: 'Local Landmarks',
      landmarksIntro: 'We reference Bath city-centre locations in your content and listings.',
      stats: { businesses: '900+', monthlySearches: '33K+', competitors: 'Medium-High', avgCPC: '£2.30' },
      localKeywords: [
        'web designer Bath city centre',
        'website design Bath city centre',
        'web design Bath BA1',
        'café website Bath',
        'restaurant website Bath',
        'salon website Bath',
        'shop website Bath',
        'local SEO Bath city centre',
      ],
      ctaHeadline: 'Ready to Get More Customers in Bath City Centre?',
      ctaSubhead: 'Join Bath businesses already ranking on Google and in the map pack.',
      ctaPrimaryText: 'Get Your Free Check Today',
      ctaSecondaryText: '07702 264 921',
      nearbyHeading: 'Other Bath Areas We Serve',
      nearbyAreas: ['bath', 'walcot-bath', 'bathwick-bath', 'widcombe-bath', 'oldfield-park-bath'],
      faqs: [
        { question: 'Do you cover Bath city centre?', answer: "Yes. We work with retailers, cafés, restaurants, salons, offices and trades right across the BA1 city-centre core — from the Abbey and SouthGate up to Milsom Street, Queen Square and Kingsmead. Get in touch for a free check on your website and Google listing." },
        { question: 'How much does a website cost for a city-centre business?', answer: 'From £250 for a single-page site, £350 for a 3-page professional site, and £450 for a 5+ page full site. Google Business Profile optimisation is a £100 add-on — well worth it for a city-centre business relying on the map pack.' },
        { question: 'Can you get my business into the Google map pack in Bath city centre?', answer: "Yes. GBP optimisation at £100 gets your listing set up correctly, and local SEO from £150/month targets Bath city-centre searches. The centre is competitive, but with the right setup a map pack position is realistic — and it's where most of the footfall-driven bookings come from." },
        { question: 'Is the city centre more competitive than the Bath suburbs?', answer: "Yes — the centre has the highest search volume and the most businesses competing, so a well-built website and a properly optimised Google listing matter more here than anywhere else in Bath. That's exactly what we do." },
      ],
      howItWorks: [
        { title: 'Free check', description: 'We review your website and Google listing.' },
        { title: 'Custom plan', description: 'Tailored for Bath city centre.' },
        { title: 'Results', description: 'Monthly updates. More leads.' },
      ],
      testimonial: { label: 'Bath Result', caseTitle: 'New Decorating, Bath & BANES', result: 'Within a week', quote: "We had no website and no Google listing — customers couldn't find us. SEO Kings built our site and set up our Google profile. Within a week we were showing up on Google Maps and getting found for painter and decorator searches in Bath and the area. Professional, fast, and it actually works. Would recommend.", name: 'Jay', business: 'New Decorating', businessDisplay: 'New Decorating • Painter & Decorator, Bath & BANES' },
    },
    ...
    'bristol': {
      ...
      subAreaSlugs: ['kingswood', 'brislington', 'whitchurch-bristol', 'knowle-bristol', 'stockwood-bristol', 'bedminster-bristol', 'southville-bristol', 'long-ashton-bristol', 'yate-bristol', 'clifton-bristol', 'horfield-bristol', 'filton-bristol', 'bradley-stoke-bristol'],
