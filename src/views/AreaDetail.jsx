...
const AreaDetail = ({ params: staticParams }) => {
  ...
  const areasData = {
    ...
    'bitton-keynsham': {
      ...
      heroSubhead: 'From £250. We also offer SEO add-ons so you get found on Google.',
      description: 'Bitton sits on the A431 between Keynsham and Bristol, straddling BS30 and BS31. It is South Gloucestershire rather than BANES — which changes how Google treats local results here.',
      extendedDescription: 'A village of period stone properties with the Avon Valley Railway on its doorstep. Trades working Bitton are usually chasing both Keynsham and Bristol searches, and most local competitors have neither a fast site nor a finished Google profile.',
      heroStats: [
      ...
      ctaButtonText: 'Get Free Check – No Obligation',
      whyIntro: 'Bitton is small, but it sits between two much bigger markets. Rank here and you pick up Keynsham and east Bristol work at the same time.',
      whyBullets: [
        { title: 'Two catchments, one site', text: 'Bitton addresses fall in BS30 and BS31. We target both, plus Keynsham and Kingswood, so one site covers the whole patch you actually drive to.' },
        { title: 'Thin local competition', text: 'Very few Bitton trades have a site that loads quickly or a Google profile with photos, services and recent reviews. The bar to outrank them is low.' },
        { title: 'Period property work', text: 'Stone cottages and listed buildings around the village and Golden Valley mean steady demand for roofers, stonemasons, lime plasterers and heritage-aware trades.' },
        { title: '5 minutes away', text: 'We are in Keynsham, the next village along the A431. You speak to the person who builds your site, not an account manager in another city.' },
      ],
      services: [
      ...
      industries: ['Trades', 'Professional Services', 'Retail', 'Construction'],
      landmarks: ['Avon Valley Railway', "St Mary's Church", 'Golden Valley', 'Bristol & Bath Railway Path', 'Bath Road (A431)'],
      landmarksHeading: 'Local Landmarks',
      landmarksIntro: 'Real Bitton references in your content — the sort of detail that tells Google you actually work here.',
      stats: { businesses: '300+', monthlySearches: '15K+', competitors: 'Low-Medium', avgCPC: '£1.50' },
      localKeywords: [
        'website design Bitton',
        'web designer Bitton',
        'plumber Bitton',
        'electrician Bitton',
        'builder Bitton',
      ...
      faqs: [
        { question: 'Do you build websites for businesses in Bitton?', answer: 'Yes. Websites start at £250 for a one-page site and £350 for three pages, live in about two weeks. We are based in Keynsham, five minutes down the A431, so site visits are easy to arrange.' },
        { question: 'Should I target Bitton, Keynsham or Bristol?', answer: 'All three, in that order of specificity. "Plumber Bitton" has low volume but almost no competition, so you can own it quickly. Keynsham gives you steady volume. Bristol is the long game. One site can target the lot — we structure your pages and Google Business Profile service areas so you are in the running for each.' },
        { question: 'Is Bitton in Bath and North East Somerset?', answer: 'No — Bitton is South Gloucestershire, though BS31 addresses sit right on the boundary with BANES. It matters for local search because Google draws on council and postal boundaries when deciding which businesses to show. We set your service areas so you are not accidentally excluded from Keynsham results.' },
        { question: 'How long before I show up in the Map Pack?', answer: 'For village-level searches like "electrician Bitton", often four to eight weeks once your Google Business Profile is properly set up with categories, services, photos and a few reviews. Broader terms like "electrician Keynsham" typically take three to six months.' },
        { question: 'What does Google Business Profile optimisation cost?', answer: '£100 as a one-off. That covers categories, services, description, photos, opening hours, service areas and a review request process you can keep using. It is the single highest-return thing most Bitton trades can do.' },
        { question: 'Do you work with heritage and period property trades?', answer: 'Yes. There is a lot of stone and listed property around Bitton and the Golden Valley. We built the site for Bath Painter, who specialises in listed buildings, lime plaster and traditional distemper — that kind of specialism is worth putting front and centre, because it removes you from competing on price alone.' },
      ],
      howItWorks: [
        { title: 'Free check', description: 'We review your site and Google profile against the other Bitton and Keynsham trades ranking above you.' },
        { title: 'Build and optimise', description: 'Fast site targeting Bitton, BS30 and Keynsham searches, with your Google profile set up properly.' },
        { title: 'Results', description: 'Monthly reports showing rankings, calls and enquiries. No lock-in contract.' },
      ],
      extraContentSection: {
        heading: 'Web design in Bitton — a small village between two big markets',
        subheading: 'Why BS30 is easier to rank than Bristol, and pays better than it looks',
        paragraphs: [
          'Bitton has roughly two thousand residents, which sounds like a poor place to base a search strategy. It is not — because almost nobody who works in Bitton only works in Bitton. Trades here cover Keynsham, Longwell Green, Hanham, Kingswood and out towards east Bristol. The village is the address; the catchment is the whole A431 corridor. A site built properly for Bitton targets that entire run, not one postcode.',
          'The advantage is competition. Search "electrician Bristol" and you are up against firms spending real money on ads and content. Search "electrician Bitton" and you will typically find a handful of Google profiles with no photos, no services listed and no reviews since 2022, plus one or two WordPress sites that take four seconds to load on a phone. That gap is the opportunity. Village-level terms convert well too — someone typing the name of their own village is nearby and ready to book.',
          'Bitton also straddles a boundary that trips people up. BS30 addresses are South Gloucestershire; BS31 runs into Keynsham and Bath and North East Somerset. Google leans on those boundaries when deciding which businesses to surface, so a profile with sloppy service areas can quietly drop out of Keynsham results despite being two miles away. We set that up deliberately rather than leaving it to chance.',
          <>The property mix matters as well. Stone cottages, the older housing around <strong>St Mary&apos;s Church</strong> and the listed buildings through Golden Valley mean steady work for roofers, stonemasons, lime plasterers and anyone comfortable with period fabric. If that is your trade, saying so plainly on your site is worth more than any amount of general copy — it is how you stop competing on price. We did exactly that for <Link href="/case-studies/bath-painter" className="text-primary hover:underline">Bath Painter</Link>, and enquiries were up within a week of launch.</>,
        ],
      },
      costSection: {
        heading: 'What it costs to get found in Bitton',
        paragraphs: [
          'Websites start at £250 for a one-page site, £350 for three pages and £450 for five or more — live in about two weeks, with six months of hosting free and £50 a year after that. Google Business Profile optimisation is £100 as a one-off. Local SEO, if you want ongoing work on rankings and citations, starts at £150 a month with no lock-in. Most Bitton businesses start with a site and the GBP work, then add SEO once it is live and earning. Free check first so you know what you actually need.',
        ],
      },
    ...
    'hanham-keynsham': {
      ...
      heroSubhead: 'From £250. We also offer SEO add-ons so you get found on Google.',
      description: 'Hanham is the largest of the villages between Keynsham and Bristol, with around 12,000 residents and a working high street of independent shops across BS15 and BS30.',
      extendedDescription: 'Unlike its neighbours, Hanham has real retail as well as trades — salons, cafés, garages and shops that live or die on local search. That makes the Map Pack the single most valuable thing on the page here.',
      heroStats: [
        { value: 'Near', label: 'Keynsham' },
      ...
      ctaButtonText: 'Get Free Check – No Obligation',
      whyIntro: 'Hanham has enough people to generate real search volume and enough businesses that the Map Pack actually gets clicked. It is the most competitive of the Keynsham villages — and the most worth winning.',
      whyBullets: [
        { title: 'Genuine search volume', text: 'At around 12,000 residents, "plumber Hanham" and "hairdresser Hanham" get searched properly rather than a handful of times a month. Ranking here pays.' },
        { title: 'Retail as well as trades', text: 'Hanham High Street has independent shops, salons and cafés. For those, the Map Pack and your Google profile matter more than the website — we set both up together.' },
        { title: 'Bristol overflow', text: 'Hanham sits on the Bristol edge in BS15. Customers searching from Brislington, St George and Kingswood are minutes away, so the realistic catchment is far bigger than the village.' },
        { title: 'Reviews decide it', text: 'With more competitors than Bitton or Warmley, review volume and recency are usually what separates the top three from the rest. We set up a request process you keep using.' },
      ],
      services: [
      ...
      industries: ['Trades', 'Professional Services', 'Retail', 'Construction'],
      landmarks: ['Hanham High Street', 'Hanham Hall', 'Conham River Park', 'Hanham Woods', 'Hanham Abbots'],
      landmarksHeading: 'Local Landmarks',
      landmarksIntro: 'Real Hanham references in your content — the sort of detail that tells Google you actually work here.',
      stats: { businesses: '350+', monthlySearches: '18K+', competitors: 'Low-Medium', avgCPC: '£1.60' },
      localKeywords: [
        'website design Hanham',
        'web designer Hanham',
        'plumber Hanham',
        'electrician Hanham',
        'builder Hanham',
      ...
      faqs: [
        { question: 'Do you build websites for businesses in Hanham?', answer: 'Yes. Websites start at £250 for a one-page site and £350 for three pages, live in about two weeks. We are in Keynsham, about ten minutes away, so we can meet in person rather than working entirely over email.' },
        { question: 'I run a shop on Hanham High Street — do I even need a website?', answer: 'You need a Google Business Profile first, and it may be all you need for a while. For a shop, salon or café, the profile is what shows in Maps with your hours, photos and reviews — that is where the customers are. GBP optimisation is £100 one-off. A one-page site at £250 then gives you somewhere to send people and something Google can index properly.' },
        { question: 'How competitive is Hanham compared to the other villages?', answer: 'The most competitive of the Keynsham villages, because it is the biggest. Expect three to six months for broader terms like "plumber Hanham", faster for anything more specific. The upside is that the volume is genuinely there — Bitton or Warmley will rank quicker but send fewer enquiries.' },
        { question: 'Should I target Hanham or Bristol?', answer: 'Start with Hanham and Kingswood, then push towards Bristol once those are holding. Hanham sits in BS15 on the Bristol edge, so you are close enough to pick up Brislington and St George work, but competing head-on for "plumber Bristol" from day one is a slow, expensive way to start.' },
        { question: 'How do I get more Google reviews?', answer: 'Ask every satisfied customer, the same day, with a direct link. Most trades never ask. We set up a short link and a message you can send by text when you finish a job, and we build review display into your site. In Hanham, review count and recency are usually what decides the top three.' },
        { question: 'Is Hanham in Bristol or South Gloucestershire?', answer: 'South Gloucestershire, though the BS15 postcode and the Bristol boundary make it feel like Bristol to most people. We set your Google service areas to cover both so you are not filtered out of either set of results.' },
      ],
      howItWorks: [
        { title: 'Free check', description: 'We review your site and Google profile against the Hanham businesses currently ranking above you.' },
        { title: 'Build and optimise', description: 'Fast site targeting Hanham, BS15 and Kingswood searches, with your Google profile and reviews sorted.' },
        { title: 'Results', description: 'Monthly reports showing rankings, calls and enquiries. No lock-in contract.' },
      ],
      extraContentSection: {
        heading: 'Web design in Hanham — the biggest of the Keynsham villages',
        subheading: 'Real search volume, a working high street, and competitors who have not bothered',
        paragraphs: [
          'Hanham is a different proposition to the villages around it. With roughly 12,000 residents it generates genuine search volume — "plumber Hanham" is a phrase people actually type, not a once-a-month curiosity. It also has something Bitton, Oldland and Warmley do not: a working high street with independent shops, salons, cafés and garages, all of them dependent on being found locally.',
          'That changes what matters. For a trade, the website carries most of the weight — service pages, areas covered, proof of work. For a shop or a salon, the Google Business Profile does the heavy lifting, because customers are looking at Maps for opening hours, photos and reviews before they look at anything else. Most Hanham businesses need both, but in different proportions, and it is worth being honest about which one earns its money first.',
          'The competition here is thicker than in the neighbouring villages, which is the trade-off for the volume. Broader terms take three to six months rather than four to eight weeks. What usually separates the top three from everyone else is not clever technical work — it is reviews. Recent ones, in reasonable numbers, mentioning the service by name. Most local businesses simply never ask their customers, which is why a business that does ask can climb past competitors who have been trading twice as long.',
          <>Hanham also sits in BS15, right on the Bristol boundary, so the practical catchment runs well past the village into Kingswood, St George and Brislington. We set your Google service areas to cover that properly rather than defaulting to a single pin. If you want to see what the same approach did for a nearby trade, the <Link href="/case-studies/new-decorating" className="text-primary hover:underline">New Decorating case study</Link> covers a business that went from no site and no listing to the Map Pack inside a week.</>,
        ],
      },
      costSection: {
        heading: 'What it costs to get found in Hanham',
        paragraphs: [
          'Websites start at £250 for a one-page site, £350 for three pages and £450 for five or more — live in about two weeks, with six months of hosting free and £50 a year after that. Google Business Profile optimisation is £100 as a one-off, and for high street businesses it is usually the first thing worth doing. Local SEO starts at £150 a month with no lock-in, which is worth considering in Hanham given the competition is real. Free check first.',
        ],
      },
      testimonial: { label: 'Keynsham & BANES Result', caseTitle: 'New Decorating, Bath & BANES', result: 'Within a week', quote: "We had no website and no Google listing — customers couldn't find us. SEO Kings built our site and set up our Google profile. Within a week we were showing up on Google Maps and getting found for painter and decorator searches in Bath and the area. Professional, fast, and it actually works. Would recommend.", name: 'Jay', business: 'New Decorating', businessDisplay: 'New Decorating • Painter & Decorator, Bath & BANES' },
    },
    'oldland-keynsham': {
      ...
      heroSubhead: 'From £250. We also offer SEO add-ons so you get found on Google.',
      description: 'Oldland Common sits in BS30 between Bitton and Longwell Green — a settled residential village of family housing, with its own stop on the Avon Valley Railway.',
      extendedDescription: 'Almost entirely homes rather than commerce, which shapes the work: extensions, loft conversions, kitchens, bathrooms and garden projects for owner-occupiers who stay put and improve rather than move.',
      heroStats: [
        { value: 'Near', label: 'Keynsham' },
      ...
      ctaButtonText: 'Get Free Check – No Obligation',
      whyIntro: 'Oldland Common is residential almost end to end. That means fewer competitors than Hanham, and customers looking for home improvement work rather than one-off call-outs.',
      whyBullets: [
        { title: 'Home improvement money', text: 'Settled owner-occupiers who extend rather than move. Extensions, loft conversions, kitchens, bathrooms and landscaping — larger jobs than emergency call-outs, and worth more per enquiry.' },
        { title: 'Almost no competition', text: 'Search "builder Oldland Common" and you will find very little. Village-level terms here are close to open, so you can hold the top spot for a long time once you take it.' },
        { title: 'Name it correctly', text: 'People search both "Oldland" and "Oldland Common", and Google treats them slightly differently. We target both rather than guessing, which is a small detail most sites get wrong.' },
        { title: 'One patch, three villages', text: 'Bitton one side, Longwell Green the other, Keynsham a few minutes south. We build for the whole run so a single site covers everywhere you would realistically drive.' },
      ],
      services: [
      ...
      industries: ['Trades', 'Professional Services', 'Retail', 'Construction'],
      landmarks: ['Oldland Common', 'Oldland Common Station', "St Anne's Church", 'Bristol & Bath Railway Path', 'Cadbury Heath'],
      landmarksHeading: 'Local Landmarks',
      landmarksIntro: 'Real Oldland Common references in your content — the sort of detail that tells Google you actually work here.',
      stats: { businesses: '280+', monthlySearches: '14K+', competitors: 'Low-Medium', avgCPC: '£1.40' },
      localKeywords: [
        'website design Oldland Common',
        'web designer Oldland',
        'builder Oldland Common',
        'plumber Oldland Common',
        'electrician Oldland Common',
        'kitchen fitter Oldland',
        'bathroom fitter Oldland',
        'extension builder BS30',
        'landscaper BS30',
        'plumber BS30',
        'builder Longwell Green',
        'electrician Keynsham',
      ...
      faqs: [
        { question: 'Do you build websites for businesses in Oldland Common?', answer: 'Yes. Websites start at £250 for a one-page site and £350 for three pages, live in about two weeks. We are in Keynsham, a few minutes down the road, so site visits are straightforward.' },
        { question: 'Should the site say Oldland or Oldland Common?', answer: 'Both. People search both forms and Google does not treat them as identical. We use the full name in your headings and schema, and the short form naturally through the copy, so you appear for either. It is a small thing that most local sites get wrong.' },
        { question: 'What kind of work does Oldland actually generate?', answer: 'Mostly domestic improvement rather than emergency call-outs. It is a settled village of owner-occupiers who extend rather than move, so the steady demand is extensions, loft conversions, kitchens, bathrooms, driveways and garden work. Those are bigger jobs, which means each enquiry is worth more and it is worth putting real detail on your service pages.' },
        { question: 'How quickly can I rank for "builder Oldland Common"?', answer: 'Village terms this specific are close to open — often four to eight weeks once your Google Business Profile is set up properly and your site has a page that actually targets the phrase. Broader terms like "builder Keynsham" or "builder Bristol" take three to six months and longer respectively.' },
        { question: 'Is it worth ranking for such a small village?', answer: 'On its own, no. As part of a patch, yes. Nobody working in Oldland Common works only in Oldland Common — you cover Bitton, Longwell Green, Cadbury Heath, Warmley and Keynsham too. We build the site to target the whole run, so the village pages feed a bigger picture rather than standing alone.' },
        { question: 'What does Google Business Profile optimisation cost?', answer: '£100 as a one-off — categories, services, description, photos, hours, service areas and a review request process you keep using. For a trade covering several BS30 villages, getting the service areas right is the difference between showing up across the patch and showing up in one spot.' },
      ],
      howItWorks: [
        { title: 'Free check', description: 'We review your site and Google profile against the other BS30 trades ranking above you.' },
        { title: 'Build and optimise', description: 'Fast site targeting Oldland Common, BS30 and the surrounding villages, with your Google profile set up properly.' },
        { title: 'Results', description: 'Monthly reports showing rankings, calls and enquiries. No lock-in contract.' },
      ],
      extraContentSection: {
        heading: 'Web design in Oldland Common — quiet village, valuable work',
        subheading: 'Why residential BS30 suits trades doing larger domestic jobs',
        paragraphs: [
          'Oldland Common is residential from one end to the other. There is no high street to speak of and very little commercial property, which sounds like bad news for a local business until you look at what the housing actually generates. This is a village of owner-occupiers who have been in the same house for years and improve rather than move — extensions, loft conversions, kitchens, bathrooms, driveways, garden rooms. Larger jobs, longer lead times, and considerably more per enquiry than a burst pipe.',
          'That should change how the site is written. A trade chasing emergency call-outs needs to look available and close. A trade chasing a £30,000 extension needs to look competent and permanent — real photographs of finished work, clear explanation of the process, honest timescales, reviews that mention the size of the job. The same site cannot do both well, and in Oldland the second one is where the money is.',
          'Competition at village level here is thin to the point of absent. Search "builder Oldland Common" or "kitchen fitter Oldland" and there is very little standing in the way. Terms this specific do not get searched often, but the people typing them are nearby and serious, and once you hold the position you tend to keep it — there is nobody actively competing to take it back. One detail worth getting right: people search both "Oldland" and "Oldland Common", and Google treats those as related but distinct. We target both rather than picking one and hoping.',
          <>The realistic strategy is a patch, not a pin. Bitton is one side, Longwell Green and Cadbury Heath the other, Warmley just north and Keynsham a few minutes south. We build one site that covers the whole run and set the Google service areas to match, so you appear across BS30 rather than in a single village. If you want to see the approach applied to a nearby trade, the <Link href="/case-studies/aspect-builds" className="text-primary hover:underline">Aspect Builds case study</Link> covers a builder who went from Instagram alone to a full site in two weeks.</>,
        ],
      },
      costSection: {
        heading: 'What it costs to get found in Oldland Common',
        paragraphs: [
          'Websites start at £250 for a one-page site, £350 for three pages and £450 for five or more — live in about two weeks, with six months of hosting free and £50 a year after that. Google Business Profile optimisation is £100 as a one-off. Local SEO starts at £150 a month with no lock-in, though in a village this quiet most trades get what they need from a good site and a properly set up profile. Free check first, and we will tell you honestly if you do not need the ongoing work.',
        ],
      },
      testimonial: { label: 'Keynsham & BANES Result', caseTitle: 'New Decorating, Bath & BANES', result: 'Within a week', quote: "We had no website and no Google listing — customers couldn't find us. SEO Kings built our site and set up our Google profile. Within a week we were showing up on Google Maps and getting found for painter and decorator searches in Bath and the area. Professional, fast, and it actually works. Would recommend.", name: 'Jay', business: 'New Decorating', businessDisplay: 'New Decorating • Painter & Decorator, Bath & BANES' },
    },
    'longwell-green-keynsham': {
      ...
      heroSubhead: 'From £250. We also offer SEO add-ons so you get found on Google.',
      description: 'Longwell Green is the commercial centre of BS30 — a retail park, leisure park and the A4174 ring road pulling in shoppers from across east Bristol and the Keynsham villages.',
      extendedDescription: 'That footfall is an advantage and a problem. Plenty of passing custom, but local searches here return national chains first, so an independent has to be deliberate about the terms it goes after.',
      heroStats: [
        { value: 'Near', label: 'Keynsham' },
        { value: 'BS30', label: 'Postcode' },
        { value: 'Top 3', label: 'Map Pack Positions Achieved' },
      ...
      ctaButtonText: 'Get Free Check – No Obligation',
      whyIntro: 'Longwell Green has the highest footfall in BS30 and the toughest search results, because the chains at the retail park occupy the obvious terms. Independents win here by being specific.',
      whyBullets: [
        { title: 'Beat the chains on specifics', text: 'You will not outrank a national retailer for a generic product term. You can own "independent", "repair", "same day" and trade-plus-village phrases the chains never target.' },
        { title: 'Wide natural catchment', text: 'The retail and leisure parks draw people from Kingswood, Hanham, Bitton, Keynsham and east Bristol. Customers already travel here, so a wider service area is credible rather than a stretch.' },
        { title: 'Commercial as well as domestic', text: 'Units, offices and shopfronts around the parks mean B2B work — maintenance, electrical, cleaning, signage — alongside the usual domestic jobs.' },
        { title: 'Ring road access', text: 'Sitting on the A4174 means you can honestly claim fast response across a wide area. That is worth saying plainly on the site, because it is the thing customers are actually weighing.' },
      ],
      services: [
      ...
      industries: ['Trades', 'Professional Services', 'Retail', 'Construction'],
      landmarks: ['Longwell Green Retail Park', 'Aspects Leisure Park', 'Longwell Green Leisure Centre', 'A4174 Ring Road', 'Cadbury Heath'],
      landmarksHeading: 'Local Landmarks',
      landmarksIntro: 'Real Longwell Green references in your content — the sort of detail that tells Google you actually work here.',
      stats: { businesses: '300+', monthlySearches: '16K+', competitors: 'Low-Medium', avgCPC: '£1.40' },
      localKeywords: [
        'website design Longwell Green',
        'web designer Longwell Green',
        'plumber Longwell Green',
        'electrician Longwell Green',
        'builder Longwell Green',
        'commercial cleaner Longwell Green',
        'shopfitter BS30',
        'signage Bristol',
        'plumber BS30',
        'electrician BS30',
      ...
      faqs: [
        { question: 'Do you build websites for businesses in Longwell Green?', answer: 'Yes. Websites start at £250 for a one-page site and £350 for three pages, live in about two weeks. We are in Keynsham, ten minutes down the road, so we can meet on site rather than working entirely remotely.' },
        { question: 'How do I compete with the chains at the retail park?', answer: 'Not on the terms they already own. You will not outrank a national retailer for a generic product search, and trying is a waste of money. What they never target is "independent", "repair", "same day", "local" and trade-plus-village phrases. Those convert better anyway, because someone searching that way has already decided they do not want the chain.' },
        { question: 'Is there commercial work as well as domestic?', answer: 'Yes — more than in the surrounding villages. The retail and leisure parks bring units, offices and shopfronts, which generate maintenance, electrical, cleaning, shopfitting and signage work. If you do both commercial and domestic, they need separate service pages, because the customers search in completely different language.' },
        { question: 'How wide a service area can I realistically claim?', answer: 'Wider than most villages, because Longwell Green already pulls customers in from Kingswood, Hanham, Bitton, Keynsham and east Bristol, and you are on the A4174 ring road. Claiming that patch is credible rather than a stretch. We set your Google service areas to match and build area pages for the ones worth targeting.' },
        { question: 'How long before I see results?', answer: 'Village and specific-service terms often move within four to eight weeks once your Google Business Profile is properly set up. Broader Bristol terms take three to six months. Anything competing directly with national chains is a longer and usually less profitable fight — we will tell you which is which before you spend anything.' },
        { question: 'What does Google Business Profile optimisation cost?', answer: '£100 as a one-off. Categories, services, description, photos, hours, service areas and a review process you keep using. In an area with this much passing trade, photos and recent reviews do a lot of work.' },
      ],
      howItWorks: [
        { title: 'Free check', description: 'We review your site and Google profile against the Longwell Green businesses currently outranking you.' },
        { title: 'Build and optimise', description: 'Fast site targeting the terms the chains ignore, with your Google profile and service areas set properly.' },
        { title: 'Results', description: 'Monthly reports showing rankings, calls and enquiries. No lock-in contract.' },
      ],
      extraContentSection: {
        heading: 'Web design in Longwell Green — competing next door to the chains',
        subheading: 'How independents win search in the busiest part of BS30',
        paragraphs: [
          'Longwell Green is the commercial heart of BS30. The retail park, Aspects Leisure Park and the A4174 ring road pull in shoppers from Kingswood, Hanham, Bitton, Keynsham and a good slice of east Bristol. For a local business that footfall is genuinely useful — but it comes with a search problem that the quieter villages do not have. Type most product or service terms with "Longwell Green" attached and the first results are national chains with budgets no independent is going to match.',
          'The answer is not to fight them for those terms. It is to go after the ones they never bother with. Chains do not target "independent", "repair", "same day", "emergency" or trade-plus-village phrases, and they are structurally bad at local nuance. Someone searching "independent bike repair Longwell Green" or "emergency electrician BS30" has already decided they do not want the retail park option. Those searches are lower volume and considerably higher intent, and they are winnable in weeks rather than years.',
          'There is also more commercial work here than anywhere else in BS30. The units, offices and shopfronts around the parks generate maintenance, electrical, cleaning, shopfitting and signage jobs on a rolling basis. If you serve both commercial and domestic customers, those need separate pages — a facilities manager and a homeowner describe the same job in entirely different words, and one page trying to speak to both usually speaks convincingly to neither.',
          <>The ring road is worth mentioning plainly too. Sitting on the A4174 means you can honestly claim a fast response across a wide area, and response time is often the thing a customer is actually weighing when they pick between two similar trades. We set your Google service areas to cover the realistic patch and build the site to match. For an example of the approach on a competitive patch, see the <Link href="/case-studies/new-decorating" className="text-primary hover:underline">New Decorating case study</Link>.</>,
        ],
      },
      costSection: {
        heading: 'What it costs to get found in Longwell Green',
        paragraphs: [
          'Websites start at £250 for a one-page site, £350 for three pages and £450 for five or more — live in about two weeks, with six months of hosting free and £50 a year after that. Google Business Profile optimisation is £100 as a one-off. Local SEO starts at £150 a month with no lock-in, and it is worth more here than in the quieter villages because the competition is real. Free check first, and we will be straight with you about which terms are worth chasing and which are not.',
        ],
      },
      testimonial: { label: 'Keynsham & BANES Result', caseTitle: 'New Decorating, Bath & BANES', result: 'Within a week', quote: "We had no website and no Google listing — customers couldn't find us. SEO Kings built our site and set up our Google profile. Within a week we were showing up on Google Maps and getting found for painter and decorator searches in Bath and the area. Professional, fast, and it actually works. Would recommend.", name: 'Jay', business: 'New Decorating', businessDisplay: 'New Decorating • Painter & Decorator, Bath & BANES' },
    },
    'warmley-keynsham': {
      ...
      heroSubhead: 'From £250. We also offer SEO add-ons so you get found on Google.',
      description: 'Warmley sits on the A420 in BS30 with the Bristol & Bath Railway Path running straight through it — one of the busiest traffic-free routes in the country.',
      extendedDescription: 'An old brass-industry village turned commuter belt. The railway path brings steady passing trade for anything customer-facing, and the A420 puts central Bristol within easy reach.',
      heroStats: [
        { value: 'Near', label: 'Keynsham' },
        { value: 'BS30', label: 'Postcode' },
        { value: 'Top 3', label: 'Map Pack Positions Achieved' },
      ...
      ctaButtonText: 'Get Free Check – No Obligation',
      whyIntro: 'Warmley has something the other BS30 villages do not — a constant stream of people passing through on the railway path, and a main road straight into Bristol.',
      whyBullets: [
        { title: 'Railway path footfall', text: 'Thousands of cyclists and walkers a week on the Bristol & Bath Railway Path. For cafés, bike shops, repairs and anything customer-facing, "near the railway path" is a search worth owning.' },
        { title: 'A420 into Bristol', text: 'A direct run into the city means you can credibly serve Kingswood, Downend and east Bristol as well as the Keynsham villages, without overstating your reach.' },
        { title: 'Low local competition', text: 'Village-level terms in Warmley are largely uncontested. Most local trades have an old site and a half-finished Google profile, so the top spots are there to be taken.' },
        { title: 'Heritage worth using', text: 'The brass works, Warmley Tower gardens and the Giant give you genuine local detail for your content — the sort of specificity that reads as local rather than generic.' },
      ],
      services: [
      ...
      industries: ['Trades', 'Professional Services', 'Retail', 'Construction'],
      landmarks: ['Bristol & Bath Railway Path', 'Warmley Station', 'Warmley Tower Gardens', 'The Warmley Giant', 'Siston Brook', 'A420'],
      landmarksHeading: 'Local Landmarks',
      landmarksIntro: 'Real Warmley references in your content — the sort of detail that tells Google you actually work here.',
      stats: { businesses: '280+', monthlySearches: '14K+', competitors: 'Low-Medium', avgCPC: '£1.40' },
      localKeywords: [
        'website design Warmley',
        'web designer Warmley',
        'plumber Warmley',
        'electrician Warmley',
        'builder Warmley',
        'bike repair Warmley',
      ...
      faqs: [
        { question: 'Do you build websites for businesses in Warmley?', answer: 'Yes. Websites start at £250 for a one-page site and £350 for three pages, live in about two weeks. We are based in Keynsham, a short run down the A4175, so site visits are easy.' },
        { question: 'Does the Bristol & Bath Railway Path bring real customers?', answer: 'For the right business, yes — it is one of the busiest traffic-free routes in the country and it runs directly through Warmley. If you are a café, bike shop, repair service or anything else people stop for, "near the Bristol and Bath railway path" is a search worth targeting, and it is one almost nobody optimises for properly.' },
        { question: 'Should I target Warmley or Bristol?', answer: 'Warmley and Kingswood first, Bristol second. The A420 puts you within easy reach of the city so claiming east Bristol is credible, but "electrician Bristol" is a three-to-six-month project at best. Warmley and BS30 terms can move in four to eight weeks and will pay for the work in the meantime.' },
        { question: 'How competitive is Warmley?', answer: 'Not very, at village level. Most local trades here have a dated site and a Google profile missing photos, services or recent reviews. That is the whole opportunity — you do not need anything clever to get past them, just the basics done properly and consistently.' },
        { question: 'What does Google Business Profile optimisation cost?', answer: '£100 as a one-off — categories, services, description, photos, opening hours, service areas and a review request process you keep using. For most Warmley businesses it is the highest-return hundred pounds available, and it usually shows results faster than the website does.' },
        { question: 'Can you use local Warmley detail in the content?', answer: 'Yes, and it helps. The old brass works, Warmley Tower gardens, the Giant, Siston Brook and the railway path are all genuine local references. Content that names real places reads as local to customers and gives Google clearer signals about where you actually work — far better than repeating the town name a dozen times.' },
      ],
      howItWorks: [
        { title: 'Free check', description: 'We review your site and Google profile against the other Warmley and Kingswood trades ranking above you.' },
        { title: 'Build and optimise', description: 'Fast site targeting Warmley, BS30 and east Bristol searches, with your Google profile set up properly.' },
        { title: 'Results', description: 'Monthly reports showing rankings, calls and enquiries. No lock-in contract.' },
      ],
      extraContentSection: {
        heading: 'Web design in Warmley — a village with passing trade built in',
        subheading: 'The railway path, the A420, and why BS30 terms are still open',
        paragraphs: [
          'Warmley has an advantage most villages of five thousand people do not: the Bristol & Bath Railway Path runs straight through the middle of it. It is one of the busiest traffic-free routes in the country, and it delivers a steady flow of cyclists, walkers and families past the village every week of the year. For a café, a bike shop, a repair service or anything else people stop for, that is passing trade arriving without you paying for it — provided they can find you when they search.',
          'Almost nobody optimises for it properly. Searches like "cafe near Bristol and Bath railway path" or "bike repair Warmley" have real intent behind them and virtually no competition, because most local businesses are still writing generic copy about serving the Bristol area. Naming the path, the station and the surrounding landmarks in your content is a small change that puts you in front of a stream of people who are literally passing your door.',
          'The A420 does the same job in the other direction. A direct run into Bristol means you can credibly serve Kingswood, Downend and the eastern side of the city as well as the Keynsham villages. That is worth stating plainly rather than hedging — customers picking between two similar trades are usually weighing how quickly you can get there, and a clear answer beats a vague service area every time.',
          <>Competition at village level is thin. Most Warmley trades are running a site that loads slowly on a phone and a Google profile that has not been touched in a couple of years. Getting past them does not require anything clever — a fast site, a properly completed profile, and reviews you actually ask for. The village also gives you genuine material to write with: the old brass works, <strong>Warmley Tower gardens</strong>, the Giant and Siston Brook are real references that read as local rather than generic. See the <Link href="/case-studies/peachy-cleans" className="text-primary hover:underline">Peachy Cleans case study</Link> for what the basics done properly look like in a similar-sized market.</>,
        ],
      },
      costSection: {
        heading: 'What it costs to get found in Warmley',
        paragraphs: [
          'Websites start at £250 for a one-page site, £350 for three pages and £450 for five or more — live in about two weeks, with six months of hosting free and £50 a year after that. Google Business Profile optimisation is £100 as a one-off and is usually the fastest win here. Local SEO starts at £150 a month with no lock-in. Free check first so you know what you actually need — in a market this uncontested, plenty of Warmley businesses do well on a good site and a properly set up profile alone.',
        ],
      },
      testimonial: { label: 'Keynsham & BANES Result', caseTitle: 'New Decorating, Bath & BANES', result: 'Within a week', quote: "We had no website and no Google listing — customers couldn't find us. SEO Kings built our site and set up our Google profile. Within a week we were showing up on Google Maps and getting found for painter and decorator searches in Bath and the area. Professional, fast, and it actually works. Would recommend.", name: 'Jay', business: 'New Decorating', businessDisplay: 'New Decorating • Painter & Decorator, Bath & BANES' },
    },
    ...
    'kingswood': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Kingswood businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'brislington': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Brislington businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'whitchurch-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Whitchurch businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'knowle-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Knowle businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'stockwood-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Stockwood businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'bedminster-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Bedminster businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'southville-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Southville businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'long-ashton-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Long Ashton businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'yate-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Yate businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'clifton-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Clifton businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'horfield-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Horfield businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'filton-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Filton businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'bradley-stoke-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Bradley Stoke businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'city-centre-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Bristol city centre businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'redcliffe-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Redcliffe businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'redland-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Redland businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'cotham-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Cotham businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'montpelier-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Stokes Croft and Montpelier businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'easton-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Easton businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'st-george-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for St George businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'totterdown-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Totterdown businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'bishopston-bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Bishopston businesses. From £150/month.', href: '/seo/bristol' },
      ],
    ...
    'bristol': {
      ...
      services: [
        ...
        { name: 'SEO Services', description: 'Full SEO — technical, on-page, content and local authority for Bristol businesses. From £150/month.', href: '/seo/bristol' },
      ],
