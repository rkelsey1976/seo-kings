...
const AreaDetail = ({ params: staticParams }) => {
  ...
  const areasData = {
    ...
    'bedminster-bristol': {
      ...
      ctaSecondaryText: '07702 264 921',
      nearbyHeading: 'Other Areas We Serve',
      nearbyAreas: ['southville-bristol', 'knowle-bristol', 'whitchurch-bristol', 'brislington', 'bristol'],
      faqs: [
    ...
    'southville-bristol': {
      ...
      ctaSecondaryText: '07702 264 921',
      nearbyHeading: 'Other Areas We Serve',
      nearbyAreas: ['bedminster-bristol', 'knowle-bristol', 'bristol', 'brislington'],
      faqs: [
    ...
    'bristol': {
      ...
      subAreaSlugs: ['kingswood', 'brislington', 'whitchurch-bristol', 'knowle-bristol', 'stockwood-bristol', 'bedminster-bristol', 'southville-bristol', 'yate-bristol'],
