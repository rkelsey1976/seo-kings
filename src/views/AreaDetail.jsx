...
const AreaDetail = ({ params: staticParams }) => {
  ...
  const areasData = {
    ...
    'city-centre-bath': {
      ...
      services: [
        { name: 'Website Design', description: 'Fast, mobile-friendly sites from £250. Our main service in Bath city centre.' },
        { name: 'Google Business Profile', description: 'Add-on: get on the map and in the pack.' },
    ...
    'lansdown-bath': {
      ...
      services: [
        { name: 'Website Design', description: 'Fast, mobile-friendly sites from £250. Our main service in Lansdown, Bath.' },
        { name: 'Google Business Profile', description: 'Add-on: get on the map and in the pack.' },
