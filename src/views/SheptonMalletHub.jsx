...
const faqs = [
  {
    q: "What's the best starting point for a Shepton Mallet business?",
    a: "Most trades do best with a website and Google Business Profile together. BA4 is one of the least competitive markets we work in — your investment goes further and results come faster. We'll tell you exactly what to prioritise in your free audit.",
  },
  {
    q: 'Can I rank in Frome and Wells as well as Shepton Mallet?',
    a: 'Yes — most Shepton trades serve the whole area. We structure your site and GBP to target multiple towns so one plan covers your whole working area.',
  },
  {
    q: 'How competitive is Shepton Mallet for local search?',
    a: 'Very low competition. Most local trades have no website or a weak Google Business Profile — the bar to reach page one is very low here and results come quickly.',
  },
  {
    q: 'How long before I see results?',
    a: "GBP improvements can show within weeks. Organic rankings for Shepton Mallet trade searches typically take 2–4 months. You'll get a monthly report so you can see exactly what's moving.",
  },
  {
    q: 'What does it cost?',
  ...
  '@graph': [
    {
      ...
      name: 'Digital Marketing in Shepton Mallet | SEO & Local Search | SEO Kings',
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Shepton Mallet' },
        ],
      },
    },
    {
      ...
      name: 'SEO Kings',
      description: 'Web design, local SEO and Google Business Profile agency serving Shepton Mallet BA4 and the surrounding Somerset area. Fast, mobile-first websites from £250 and local SEO from £150/month for trades and local businesses across Shepton Mallet, Frome and Wells.',
      url: 'https://seo-kings.co.uk/areas/shepton-mallet',
    ...
    <>
      ...
      <section className="py-24 bg-dark-lighter border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <SectionTag className="mb-4">Our services in Shepton Mallet</SectionTag>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 leading-tight tracking-tight">
              Everything you need to get found in Shepton Mallet
            </h2>
            <p className="text-gray-400 leading-relaxed max-w-2xl">
              Most Shepton Mallet trades have no Google presence. Three services, one team — website, local SEO and GBP — so local customers find you first, not a competitor from Frome or Wells.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    ...
                    'Built to rank for your trade + Shepton Mallet searches',
              ...
              <div className="mt-auto">
                ...
                >
                  Website Design in Shepton Mallet →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Shepton Mallet has very low online competition. The businesses in the map pack take most of the calls — and getting there is more achievable here than almost anywhere else we work. We get you in and keep you there.
              </p>
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    'Google Business Profile optimisation',
                    'On-page SEO for Shepton Mallet trade keywords',
              ...
              <div className="mt-auto">
                <Link
                  href="/local-seo/shepton-mallet"
                  className="block w-full text-center px-6 py-3 rounded-lg font-semibold text-white transition-all duration-200 bg-primary-dark"
                >
                  Local SEO in Shepton Mallet →
                </Link>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              We&apos;re based in Keynsham — well placed to serve Shepton Mallet and the wider BA4 area. Shepton sits at the edge of the Mendips: market town with a strong trades community, growing population, and very low online competition. Most local businesses have no website or a neglected one.
            </p>
            <p className="text-gray-400 leading-relaxed mb-8">
              We cover Shepton Mallet and the surrounding area: Frome, Wells, Glastonbury, Midsomer Norton, Evercreech, Pilton and the wider Somerset market. Many Shepton clients also want to rank across the Somer Valley — we structure everything to cover your whole working area.
            </p>
            <a
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-white mb-10 leading-tight tracking-tight">Common questions about our Shepton Mallet services</h2>
...
export default SheptonMalletHub;
