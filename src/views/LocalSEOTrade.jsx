...
const tradesData = {
  plumbers: {
    name: 'Plumbers',
    headline: 'Local SEO for Plumbers in Bath, Bristol & North East Somerset',
    intro: 'When someone in Bath or Keynsham searches "plumber near me" or "emergency plumber Bath", they\'re ready to hire. If you\'re not on page one of Google, your competitors are getting those calls. We help plumbers across Bath, Bristol and North East Somerset rank higher so you get more enquiries and more jobs.',
    whatWeDo: [
    ...
    faqs: [
      ...
      { q: 'Do you work with one-man bands?', a: 'Yes. We work with sole traders, small teams, and larger plumbing firms across Bath, Bristol and North East Somerset. The goal is the same: get you found when local customers search for a plumber.' },
      { q: 'What areas do you cover?', a: 'Bath, Bristol, Keynsham, Midsomer Norton, Radstock, Peasedown St John, Paulton, Saltford, Timsbury and all of Bath, Bristol and North East Somerset.' },
    ],
    metaTitle: 'Local SEO for Plumbers in Bath, Bristol & North East Somerset',
    metaDescription: 'Get more plumbing jobs from Google. We help plumbers in Bath, Keynsham, Midsomer Norton , Bristol and North East Somerset rank #1 for local searches. Free audit.',
  },
  electricians: {
    name: 'Electricians',
    headline: 'Local SEO for Electricians in Bath, Bristol & North East Somerset',
    intro: 'Searches like "electrician Bath" and "electrician Keynsham" are made by people ready to book. If you\'re not on the first page of Google, you\'re missing those jobs. We help electricians across Bath, Bristol and North East Somerset get found, get more calls, and win more work.',
    whatWeDo: [
    ...
    metaTitle: 'Local SEO for Electricians in Bath, Bristol & North East Somerset',
    metaDescription: 'Get more electrical jobs from Google. We help electricians in Bath, Keynsham, Radstock , Bristol and North East Somerset rank #1 for local searches. Free audit.',
  },
  roofers: {
    name: 'Roofers',
    headline: 'Local SEO for Roofers in Bath, Bristol & North East Somerset',
    intro: 'Homeowners searching "roofer Bath" or "roofing Keynsham" are looking for someone now. We help roofers across Bath, Bristol and North East Somerset rank on Google so you appear when it matters and get more enquiries.',
    whatWeDo: [
    ...
    faqs: [
      ...
      { q: 'What areas do you cover?', a: 'Bath, Bristol, Keynsham, Midsomer Norton, Radstock, Peasedown St John, Paulton, Saltford, Timsbury and all of Bath and North East Somerset.' },
    ],
    metaTitle: 'Local SEO for Roofers in Bath, Bristol & North East Somerset',
    metaDescription: 'Get more roofing jobs from Google. We help roofers in Bath, Midsomer Norton, Keynsham , Bristol and North East Somerset rank #1 for local searches. Free audit.',
  },
  builders: {
    name: 'Builders',
    headline: 'Local SEO for Builders in Bath, Bristol & North East Somerset',
    intro: 'People searching "builder Bath" or "building company Keynsham" are planning big projects — extensions, renovations, new builds. They research carefully before choosing. We help builders across Bath, Bristol and North East Somerset appear at the top of Google so you win those larger, higher-value jobs.',
    whatWeDo: [
    ...
    metaTitle: 'Local SEO for Builders in Bath, Bristol & North East Somerset',
    metaDescription: 'Get more building enquiries from Google. We help builders in Bath, Keynsham, Midsomer Norton , Bristol and North East Somerset rank #1 for local searches. Free audit.',
  },
  landscapers: {
    name: 'Landscapers',
    headline: 'Local SEO for Landscapers & Gardeners in Bath, Bristol & North East Somerset',
    intro: 'Garden projects start with a Google search. "Landscaper Bath", "garden designer Keynsham", "patio builder Midsomer Norton" — these are high-intent searches from people ready to spend. We help landscapers and gardeners across Bath, Bristol and North East Somerset rank higher and win more projects.',
    whatWeDo: [
    ...
    metaTitle: 'Local SEO for Landscapers in Bath, Bristol & North East Somerset',
    metaDescription: 'Get more landscaping jobs from Google. We help landscapers and gardeners in Bath, Keynsham, Midsomer Norton , Bristol and BANES rank #1 for local searches. Free audit.',
  },
  cleaners: {
    name: 'Cleaning Services',
    headline: 'Local SEO for Cleaning Services in Bath, Bristol & North East Somerset',
    intro: 'When someone searches "cleaner Bath" or "cleaning services Keynsham", they want someone reliable and local. The cleaning industry is competitive — but most competitors have poor SEO. We help cleaning businesses across Bath, Bristol and North East Somerset rank higher with the right strategy.',
    whatWeDo: [
    ...
    metaTitle: 'Local SEO for Cleaning Services in Bath, Bristol & North East Somerset',
    metaDescription: 'Get more cleaning enquiries from Google. We help cleaners in Bath, Keynsham, Midsomer Norton , Bristol and BANES rank #1 for local searches. Free audit.',
  },
  'painters-decorators': {
    name: 'Painters & Decorators',
    headline: 'Local SEO for Painters & Decorators in Bath, Bristol & North East Somerset',
    intro: 'Bath has more period properties than almost anywhere in the UK. Searches like "painter decorator Bath", "decorator Keynsham" and "heritage painting Midsomer Norton" come from homeowners planning real projects. We help painters and decorators across Bath, Bristol and North East Somerset rank higher and win more work.',
    whatWeDo: [
    ...
    metaTitle: 'Local SEO for Painters & Decorators in Bath, Bristol & North East Somerset',
    metaDescription: 'Get more painting and decorating jobs from Google. We help painters in Bath, Keynsham, Midsomer Norton , Bristol and BANES rank #1 for local searches. Free audit.',
  },
  'kitchen-fitters': {
    name: 'Kitchen Fitters',
    headline: 'Local SEO for Kitchen Fitters in Bath, Bristol & North East Somerset',
    intro: 'Kitchen renovations are big-ticket projects — homeowners research carefully before choosing a fitter. When they search "kitchen fitter Bath" or "kitchen installation Keynsham", they need to find you. We help kitchen fitters across Bath, Bristol and North East Somerset rank higher and win those high-value jobs.',
    whatWeDo: [
    ...
    metaTitle: 'Local SEO for Kitchen Fitters in Bath, Bristol & North East Somerset',
    metaDescription: 'Get more kitchen fitting enquiries from Google. We help kitchen fitters in Bath, Keynsham, Midsomer Norton , Bristol and BANES rank #1 for local searches. Free audit.',
  },
  'bathroom-fitters': {
    name: 'Bathroom Fitters',
    headline: 'Local SEO for Bathroom Fitters in Bath, Bristol & North East Somerset',
    intro: 'Bathroom renovations are one of the most searched-for home improvements. "Bathroom fitter Bath", "bathroom installation Keynsham" — these are high-intent searches from homeowners ready to spend. We help bathroom fitters across Bath, Bristol and North East Somerset rank higher and win more projects.',
    whatWeDo: [
    ...
    metaTitle: 'Local SEO for Bathroom Fitters in Bath, Bristol & North East Somerset',
    metaDescription: 'Get more bathroom fitting enquiries from Google. We help bathroom fitters in Bath, Keynsham, Midsomer Norton , Bristol and BANES rank #1 for local searches. Free audit.',
  },
  'heating-engineers': {
    name: 'Heating Engineers',
    headline: 'Local SEO for Heating Engineers in Bath, Bristol & North East Somerset',
    intro: 'Boiler breakdowns, annual services, heat pump installations — heating jobs come from urgent searches. "Heating engineer Bath", "boiler repair Keynsham", "gas engineer Midsomer Norton" — these are people who need you now. We help heating engineers across Bath, Bristol and North East Somerset rank higher and get those calls.',
    whatWeDo: [
    ...
    metaTitle: 'Local SEO for Heating Engineers in Bath, Bristol & North East Somerset',
    metaDescription: 'Get more boiler and heating jobs from Google. We help heating engineers in Bath, Keynsham, Midsomer Norton , Bristol and BANES rank #1 for local searches. Free audit.',
  },
  plasterers: {
    name: 'Plasterers',
    headline: 'Local SEO for Plasterers in Bath, Bristol & North East Somerset',
    intro: 'Plastering work comes from renovators, builders, and homeowners doing up period properties. "Plasterer Bath", "plastering Keynsham", "skim plasterer Midsomer Norton" — these searches lead to real jobs. We help plasterers across Bath, Bristol and North East Somerset rank higher and win more work.',
    whatWeDo: [
    ...
    metaTitle: 'Local SEO for Plasterers in Bath, Bristol & North East Somerset',
    metaDescription: 'Get more plastering jobs from Google. We help plasterers in Bath, Keynsham, Midsomer Norton , Bristol and BANES rank #1 for local searches. Free audit.',
  },
  'gas-engineers': {
    name: 'Gas Engineers',
    headline: 'Local SEO for Gas Engineers in Bath, Bristol & North East Somerset',
    intro: 'Gas Safe registration is your biggest trust signal — but it means nothing if customers cannot find you. "Gas engineer Bath", "boiler repair Keynsham", "gas safe plumber Midsomer Norton" — these emergency and installation searches are high-intent and high-value. We help gas engineers across Bath, Bristol and North East Somerset rank higher and get more calls.',
    whatWeDo: [
    ...
    metaTitle: 'Local SEO for Gas Engineers in Bath, Bristol & North East Somerset',
    metaDescription: 'Get more boiler repair and gas engineer enquiries from Google. We help Gas Safe engineers in Bath, Keynsham, Midsomer Norton , Bristol and BANES rank #1 for local searches. Free audit.',
  },
  'loft-conversions': {
    name: 'Loft Conversion Specialists',
    headline: 'Local SEO for Loft Conversion Specialists in Bath, Bristol & North East Somerset',
    intro: 'Loft conversions are one of the highest-value home improvement searches in Bath. Period properties, restricted space, planning complexity — homeowners search specifically for "loft conversion Bath", "dormer loft Keynsham", "velux conversion Midsomer Norton". We help loft converters across Bath, Bristol and North East Somerset rank higher and win these big jobs.',
    whatWeDo: [
    ...
    metaTitle: 'Local SEO for Loft Conversion Specialists in Bath, Bristol & North East Somerset',
    metaDescription: 'Get more loft conversion enquiries from Google. We help loft converters in Bath, Keynsham, Midsomer Norton , Bristol and BANES rank #1 for local searches. Free audit.',
  },
  'extension-builders': {
    name: 'Extension Builders',
    headline: 'Local SEO for Extension Builders in Bath, Bristol & North East Somerset',
    intro: 'Home extensions in Bath are big business — £30-80k projects from homeowners who search "house extension Bath", "rear extension Keynsham", "side return extension Midsomer Norton". These are considered, high-value searches. We help extension builders across Bath, Bristol and North East Somerset rank higher and win these contracts.',
    whatWeDo: [
    ...
    metaTitle: 'Local SEO for Extension Builders in Bath, Bristol & North East Somerset',
    metaDescription: 'Get more extension enquiries from Google. We help extension builders in Bath, Keynsham, Midsomer Norton , Bristol and BANES rank #1 for local searches. Free audit.',
  },
  'drainage-engineers': {
    name: 'Drainage Engineers',
    headline: 'Local SEO for Drainage Engineers in Bath, Bristol & North East Somerset',
    intro: 'Drainage problems are urgent. "Drain unblocking Bath", "drainage engineer Keynsham", "CCTV drain survey Midsomer Norton" — these are emergency searches from people who need help now. We help drainage engineers across Bath, Bristol and North East Somerset rank higher and capture these high-intent calls.',
    whatWeDo: [
    ...
    metaTitle: 'Local SEO for Drainage Engineers in Bath, Bristol & North East Somerset',
    metaDescription: 'Get more drainage enquiries from Google. We help drainage engineers in Bath, Keynsham, Midsomer Norton , Bristol and BANES rank #1 for local searches. Free audit.',
  },
};
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-400 mb-6">
            We help {trade.name.toLowerCase()} in Bath, Keynsham, Midsomer Norton, Radstock, Peasedown St John, Paulton, Saltford, Timsbury and across Bath, Bristol and North East Somerset.
          </p>
