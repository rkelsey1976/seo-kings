  ...
  '@graph': [
    {
      ...
      description: 'Websites for bathroom fitters in Bath & Somerset. Fast, mobile-first, built to rank for local search. Project galleries, before/after photos, dedicated service pages. From £250. Add GBP optimisation for £100.',
      inLanguage: 'en-GB',
    ...
    },
    {
      ...
      offers: {
        ...
        price: '399',
        priceCurrency: 'GBP',
        description: 'Bathroom fitter website from £250 — GBP optimisation available as a £100 add-on',
      },
    },
    {
      '@type': 'LocalBusiness',
  ...
  return (
    <>
      <SEO
        ...
        description="Websites for bathroom fitters in Bath & Somerset. Fast, mobile-first, built for local search. Project galleries, before/after photos, service pages. From £250. Add GBP optimisation for £100."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6 leading-tight tracking-tight">
              Web Design for{' '}
              <span className="text-primary">Bathroom Fitters</span>
              {' '}in Bath & Somerset
            </h1>
            ...
            <p className="text-lg text-gray-400 leading-relaxed max-w-2xl mb-8">
              We build websites for bathroom fitters in Bath, Keynsham, Midsomer Norton and across North East Somerset — with project galleries, dedicated service pages for wet rooms, tiling and underfloor heating, from £250. Add GBP optimisation for £100.
            </p>
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-6 leading-tight tracking-tight">Why most bathroom fitter websites don't generate enquiries</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl font-bold text-white mb-6 leading-tight tracking-tight">Built specifically for bathroom fitting businesses</h2>
          ...
          <div className="max-w-2xl">
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                { name: 'Full', desc: '5+ pages — home, service pages, listed buildings, service areas, about', price: 'From £450' },
              ].map((pkg) => (
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-6 leading-tight tracking-tight">We know the Bath & Somerset bathroom fitting market</h2>
            <p className="text-gray-400 leading-relaxed mb-4">
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-white mb-10 leading-tight tracking-tight">Common questions about bathroom fitter websites</h2>
