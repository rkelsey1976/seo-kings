...
const faqs = [
  {
    q: "What's the best starting point for a Bradford on Avon business?",
    a: "Most Bradford on Avon trades do best starting with a website and Google Business Profile together. BA15 is far less competitive than Bath — your investment goes further and results come faster. We'll tell you exactly what to prioritise in your free audit.",
  },
  {
    q: 'Can I rank in Bath and Trowbridge as well as Bradford on Avon?',
    a: 'Yes — most Bradford on Avon trades serve Bath and Wiltshire. We structure your site and GBP to target multiple towns, so one plan covers your whole working area without extra cost.',
  },
  {
    q: 'How competitive is Bradford on Avon for local search?',
    a: 'Very low competition. Most local trades have no website or a weak Google Business Profile — the bar to reach page one is significantly lower here than in Bath, and results come much faster.',
  },
  {
    q: 'How long before I see results?',
    a: "GBP improvements can show within weeks. Organic rankings for Bradford on Avon trade searches typically take 2–4 months. You'll get a monthly report so you can see exactly what's moving.",
  },
  {
    q: 'What does it cost?',
  ...
  '@graph': [
    {
      ...
      name: 'Digital Marketing in Bradford-on-Avon | SEO & Local Search | SEO Kings',
      description: 'Local SEO, Google Business Profile and web design for trades and local businesses in Bradford-on-Avon BA15. Websites from £250, local SEO from £150/month. Free audit — no obligation.',
      inLanguage: 'en-GB',
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Bradford on Avon' },
        ],
      },
    },
    {
      ...
      name: 'SEO Kings',
      description: 'Web design, local SEO and Google Business Profile agency serving Bradford on Avon BA15 and the surrounding Wiltshire area. Fast, mobile-first websites from £250 and local SEO from £150/month for trades and local businesses across Bradford on Avon, Bath and Trowbridge.',
      url: 'https://seo-kings.co.uk/areas/bradford-on-avon',
    ...
    <>
      ...
      <section className="py-24 bg-dark-lighter border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <SectionTag className="mb-4">Our services in Bradford on Avon</SectionTag>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 leading-tight tracking-tight">
              Everything you need to get found in Bradford on Avon
            </h2>
            <p className="text-gray-400 leading-relaxed max-w-2xl">
              Bradford on Avon homeowners spend on quality — extensions, heritage restoration, premium trades. Three services, one team — website, local SEO and GBP working together to put you in front of them first.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    ...
                    'Built to rank for your trade + Bradford on Avon searches',
              ...
              <div className="mt-auto">
                <Link
                  href="/website-designer-bradford-on-avon"
                ...
                >
                  Website Design in Bradford on Avon →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Bradford on Avon has far less competition than Bath or Trowbridge. The businesses in the map pack take most of the calls — and getting there is more achievable here. We get you in and keep you there.
              </p>
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    'Google Business Profile optimisation',
                    'On-page SEO for Bradford on Avon trade keywords',
              ...
              <div className="mt-auto">
                <Link
                  href="/local-seo/bradford-on-avon"
                  className="block w-full text-center px-6 py-3 rounded-lg font-semibold text-white transition-all duration-200 bg-primary-dark"
                >
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-white mb-6 leading-tight tracking-tight">We know the Bradford on Avon market</h2>
            <p className="text-gray-400 leading-relaxed mb-4">
              We&apos;re based in Keynsham — just up the road from Bradford on Avon. We understand the BA15 market: affluent homeowners, period properties, premium trades, and very low SEO competition. Most trades in Bradford on Avon have either no website or a poor one — the opportunity to rank is genuinely strong.
            </p>
            <p className="text-gray-400 leading-relaxed mb-8">
              We cover Bradford on Avon and the surrounding area: Bath, Trowbridge, Corsham, Melksham, Winsley and the Limpley Stoke Valley. Many Bradford on Avon clients also want to rank across Wiltshire and into Bath — we structure everything so one plan covers your whole working area.
            </p>
            <a
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-white mb-10 leading-tight tracking-tight">Common questions about our Bradford on Avon services</h2>
...
export default BradfordOnAvonHub;
