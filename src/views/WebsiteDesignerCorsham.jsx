...
const WebsiteDesignerCorsham = () => {
  ...
  return (
    <>
      <SEO
        title="Website Designer Corsham | Web Design from £250"
        description="Website designer serving Corsham SN13. Fast, mobile-first websites for trades and local businesses from £250. GBP optimisation from £100. Free audit."
        canonical="/website-designer-corsham"
        breadcrumbs={[
          { name: 'Home', url: '/' },
          { name: 'Website Designer Corsham' },
        ]}
        schemas={[schema]}
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            <span className="inline-block px-3 py-1 bg-primary/10 border border-primary/20 rounded-full text-[11px] font-mono font-medium tracking-[0.12em] uppercase mb-6 text-primary">
              Serving Corsham · SN13
            </span>
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6 leading-tight tracking-tight">
              Website Designer{' '}
              <span className="text-primary">Corsham</span>
            </h1>
            <p className="text-xl text-gray-400 leading-relaxed max-w-2xl mb-8">
              We build fast, Google-ready websites for trades and local businesses in Corsham SN13. From £250. Add GBP optimisation for £100. Live in under 2 weeks.
            </p>
