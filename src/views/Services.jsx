...
const services = [
  {
    ...
    price: 'From £250',
    tag: 'Core Service',
    description: 'A fast, mobile-first website built to rank for your trade locally. One-page sites from £250. Multi-page sites are £250 base + £50 per page. Click-to-call and quote form included. Add GBP optimisation for £100.',
    bullets: [
  ...
  },
  {
    ...
    price: '£100 one-off',
    tag: 'Add-on',
    description: 'Claim, verify and fully optimise your GBP so you show up in the Map Pack — the top 3 results that capture the majority of local clicks. One-off £100 add-on.',
    bullets: [
      'Claim and verify your listing',
      'Full optimisation for Map Pack',
      'Categories, keywords and services set up',
      '£100 one-off — no monthly fee',
    ],
