...
const faqs = [
  {
    q: "What's the best starting point for a Clutton business?",
    a: "For most trades, a website and Google Business Profile together give the strongest foundation. Clutton is a very low-competition market — much easier than Bath or Bristol — so the right strategy gets you visible fast. We'll tell you what to prioritise in your free audit.",
  },
  {
    q: 'Can I rank in Bath and Bristol as well as Clutton?',
    a: "Yes — most Clutton trades serve a wide area. We structure your site and GBP to target multiple locations from one plan, so you're visible across your whole working area.",
  },
  {
    q: 'How competitive is Clutton for local search?',
    a: "Very low competition. Most local trades have no website or a weak GBP — the bar to get on page one is low here and results come quickly.",
  },
  {
    q: 'How long before I see results?',
    a: "GBP improvements can show within weeks. Organic rankings for Clutton trade searches typically take 2–4 months. You'll get a monthly report showing exactly what's moving.",
  },
  {
    q: 'What does it cost?',
...
const schema = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://seo-kings.co.uk/areas/clutton',
      url: 'https://seo-kings.co.uk/areas/clutton',
      name: 'Web Design & SEO in Clutton | BS39 Trades & Businesses | SEO Kings',
      description: 'Web design, local SEO and Google Business Profile for trades and local businesses in Clutton BS39. Websites from £250, local SEO from £150/month. Free audit — no obligation.',
      inLanguage: 'en-GB',
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Clutton' },
        ],
      },
    },
    {
      ...
      name: 'SEO Kings',
      description: 'Web design, local SEO and Google Business Profile agency serving Clutton BS39 and the surrounding area. Fast, mobile-first websites from £250 and local SEO from £150/month for trades and local businesses across Clutton, Bath and Bristol.',
      url: 'https://seo-kings.co.uk/areas/clutton',
...
const CluttonHub = () => {
  return (
    <>
      <SEO
        title="Web Design & SEO in Clutton | BS39 Trades & Businesses"
        description="Web design, local SEO and Google Business Profile for trades and local businesses in Clutton BS39. Websites from £250, local SEO from £150/month. Free audit — no obligation."
        canonical="/areas/clutton"
        breadcrumbs={[
          { name: 'Home', url: '/' },
          { name: 'Clutton' },
        ]}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6 leading-tight tracking-tight">
              Web Design &amp; SEO in{' '}
              <span className="text-primary">Clutton</span>
            </h1>
            <p className="text-xl text-gray-400 leading-relaxed max-w-2xl mb-4">
              One team. Three services. All focused on getting your Clutton business found on Google.
            </p>
            <p className="text-base text-gray-400 leading-relaxed max-w-2xl mb-8">
              Clutton sits in a rural corridor between Bath and Bristol — very low competition, and trades here serve the Chew Valley, Somer Valley and both cities. The right strategy gets you visible fast across your whole working area, all from a single plan.
            </p>
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <SectionTag className="mb-4">Our services in Clutton</SectionTag>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 leading-tight tracking-tight">
              Everything you need to get found in Clutton
            </h2>
            <p className="text-gray-400 leading-relaxed max-w-2xl">
              Three services, one team, clear monthly pricing. Most Clutton clients combine website design and local SEO — and see results faster here than in Bath or Bristol because the competition is so much lower.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Fast, mobile-first websites for Clutton trades and local businesses — built for local search from day one, not as an afterthought.
              </p>
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    'Mobile-first design, loads fast on any device',
                    'Built to rank for your trade + Clutton searches',
              ...
              <div className="mt-auto">
                ...
                >
                  Website Design for Clutton Businesses →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Clutton has far less competition than Bath or Bristol. The businesses in the map pack take most of the calls — and getting there is more achievable here. We get you in and keep you there, visible across BS39 and beyond.
              </p>
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    'Google Business Profile optimisation',
                    'On-page SEO for Clutton trade keywords',
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-white mb-6 leading-tight tracking-tight">We know the Chew Valley and Somer Valley</h2>
            <p className="text-gray-400 leading-relaxed mb-4">
              We&apos;re based in Keynsham — a short drive from Clutton. The village sits between Bath and Bristol in a rural corridor where most trades serve a wide area. We know which searches drive enquiries across BS39 and how to build visibility in Bath, Bristol and the Somer Valley from a single plan.
            </p>
            <p className="text-gray-400 leading-relaxed mb-8">
              We cover the whole of the BS39 area — Temple Cloud, Hallatrow, High Littleton, Pensford, and the wider BS39 postcode.
            </p>
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-white mb-10 leading-tight tracking-tight">Common questions about our Clutton services</h2>
