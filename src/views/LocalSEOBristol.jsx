...
const faqs = [
  ...
  },
  {
    ...
    aHtml: linkifyBristolSuburbs('All of BS1 to BS16, including every major neighbourhood. Clifton, Bedminster, Horfield, Filton, Bradley Stoke, Brislington, Whitchurch, Knowle, Stockwood, Southville, Long Ashton, Yate, Kingswood, Redland, Bishopston and Cotham. We also cover Keynsham, Bath, and the wider Somerset and South Gloucestershire area. If you serve any part of this patch, our local SEO Bristol campaigns are structured to target the specific neighbourhoods and postcodes where your customers are searching.'),
  },
];
  ...
  '@graph': [
    ...
    },
    {
      ...
      areaServed: [
        ...
        { '@type': 'City', name: 'Clifton', sameAs: 'https://en.wikipedia.org/wiki/Clifton,_Bristol' },
        { '@type': 'City', name: 'Bedminster', sameAs: 'https://en.wikipedia.org/wiki/Bedminster' },
        { '@type': 'City', name: 'Horfield', sameAs: 'https://en.wikipedia.org/wiki/Horfield' },
        { '@type': 'City', name: 'Filton', sameAs: 'https://en.wikipedia.org/wiki/Filton' },
        { '@type': 'City', name: 'Bradley Stoke', sameAs: 'https://en.wikipedia.org/wiki/Bradley_Stoke' },
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-2 leading-tight tracking-tight">
            Local SEO across every Bristol neighbourhood
          </h2>
