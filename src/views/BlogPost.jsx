...
const blogPosts = {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'When someone searches "electrician Keynsham" or "website design Keynsham," Google shows a mix of organic results and the local map pack (the three businesses with map pins). Getting into that pack, and onto page 1, depends on having a proper website and a well-optimised Google Business Profile. Learn more about our [website design in Keynsham](https://seo-kings.co.uk/website-designer-keynsham) to see how we set up and optimise your GBP so you show up when it matters.',
  ...
  'how-we-build-websites-keynsham': {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'After launch we submit the site to Google, set up or tidy your GBP if needed, and make sure everything is connected. We don\'t stop at "the site is live" - we want it to start showing up for the searches we targeted. For many Keynsham businesses that means appearing in the map pack and for "near me" searches as well as for specific phrases like "electrician Keynsham". See our [Keynsham web design service](https://seo-kings.co.uk/website-designer-keynsham) to see how we bring this process to life for real businesses.',
    ...
    sections: [
      {
        ...
        paragraphs: [
          'Your Google Business Profile is one of the main ways you show up when people in Keynsham, Saltford, or BS31 search for your trade or service. But Google has to understand what you do and where you serve. Keyword research for your GBP means finding the phrases people actually type in - like "plumber Keynsham", "electrician BS31", or "painter and decorator Saltford" - and using them in your category, services, description and areas so Google can match you to the right searches. Our Keynsham web design service includes GBP keyword research and optimisation as a £100 add-on.',
  ...
  'website-design-peasedown-st-john': {
    ...
    ctaLinks: [
      { href: '/website-designer-peasedown-st-john', label: 'Website design Peasedown St John' },
      { href: '/web-design', label: 'Website design services' },
      { href: '/web-design-packages', label: 'Web design packages' },
      { href: '/contact', label: 'Get a free quote' },
    ],
  ...
  'website-design-somer-valley': {
    ...
    ctaLinks: [
      ...
      { href: '/website-designer-midsomer-norton', label: 'Website designer Midsomer Norton' },
      { href: '/local-seo/midsomer-norton', label: 'Local SEO Midsomer Norton' },
      { href: '/website-designer-radstock', label: 'Website design Radstock' },
      { href: '/website-designer-midsomer-norton', label: 'Website design Midsomer Norton' },
      { href: '/web-design', label: 'Website design services' },
      { href: '/contact', label: 'Get a free quote' },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '"Won\'t a website be expensive?" Our £250 starter package gets you a one-page, mobile-friendly site built for local search. Add GBP optimisation for £100 and you\'re showing up on Maps too. So you show up when people search website design Keynsham, the market, or your type of produce. Get a free quote or ring 07702 264 921.',
