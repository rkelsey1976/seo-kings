  ...
  '@graph': [
    {
      ...
      description: 'Websites for roofers in Bath & Somerset. Fast, mobile-first, built to rank for emergency and local search. Before/after galleries, dedicated service pages, Google Business Profile included. From £250.',
      inLanguage: 'en-GB',
    ...
    },
    {
      ...
      offers: {
        ...
        price: '399',
        priceCurrency: 'GBP',
        description: 'Roofer website from £250 including Google Business Profile set-up',
      },
    },
    {
      '@type': 'LocalBusiness',
  ...
  return (
    <>
      <SEO
        ...
        description="Websites for roofers in Bath & Somerset. Fast, mobile-first, built for emergency and local search. Before/after galleries, service pages, Google Business Profile included. From £250."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-gray-400 leading-relaxed max-w-2xl mb-8">
              We build websites for roofers in Bath, Keynsham, Midsomer Norton and across North East Somerset — with before/after galleries, dedicated emergency pages, insurance work pages, and Google Business Profile optimisation as standard. From £250.
            </p>
