  ...
  '@graph': [
    {
      ...
      description: 'Websites for roofers in Bath & Somerset. Fast, mobile-first, built to rank for emergency and local search. Before/after galleries, dedicated service pages, Google Business Profile included. From £399.',
      inLanguage: 'en-GB',
    ...
    },
    {
      ...
      offers: {
        ...
        price: '399',
        priceCurrency: 'GBP',
        description: 'Roofer website from £399 including Google Business Profile set-up',
      },
    },
    {
      '@type': 'LocalBusiness',
...
const WebDesignForRoofers = () => {
  return (
    <>
      <SEO
        title="Web Design for Roofers Bath & Somerset | From £399"
        description="Websites for roofers in Bath & Somerset. Fast, mobile-first, built for emergency and local search. Before/after galleries, service pages, Google Business Profile included. From £399."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6 leading-tight tracking-tight">
              Web Design for{' '}
              <span style={{ color: '#E8715A' }}>Roofers</span>
              {' '}in Bath & Somerset
            </h1>
            ...
            <p className="text-lg text-gray-400 leading-relaxed max-w-2xl mb-8">
              We build websites for roofers in Bath, Keynsham, Midsomer Norton and across North East Somerset — with before/after galleries, dedicated emergency pages, insurance work pages, and Google Business Profile optimisation as standard. From £399.
            </p>
            ...
            <div className="flex flex-wrap gap-6 mt-10">
              {['From £399', 'Before/after gallery included', 'Emergency page as standard', '6 months free hosting', 'Live in under 2 weeks'].map((t) => (
      ...
      <section className="py-20 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-6">Why most roofer websites don't generate calls</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl font-bold text-white mb-6">Built specifically for roofing businesses</h2>
      ...
      <section className="py-20 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-6">We know the Bath & Somerset roofing market</h2>
            <p className="text-gray-400 leading-relaxed mb-4">
      ...
      <section className="py-20 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-10">Common questions about roofer websites</h2>
