  ...
  '@graph': [
    {
      ...
      description: 'Websites for drainage engineers in Bath & Somerset. Fast, mobile-first, built to rank for emergency and local search. 24/7 availability, CCTV survey pages, drain unblocking, Google Business Profile included. From £250.',
      inLanguage: 'en-GB',
    ...
    },
    {
      ...
      offers: {
        ...
        price: '399',
        priceCurrency: 'GBP',
        description: 'Drainage engineer website from £250 including Google Business Profile set-up',
      },
    },
    {
      '@type': 'LocalBusiness',
  ...
  return (
    <>
      <SEO
        ...
        description="Websites for drainage engineers in Bath & Somerset. Fast, mobile-first, built for emergency and local search. 24/7 availability, CCTV survey pages, drain unblocking, Google Business Profile included. From £250."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-gray-400 leading-relaxed max-w-2xl mb-8">
              We build websites for drainage engineers in Bath, Keynsham, Midsomer Norton and across North East Somerset — with emergency drain unblocking pages, CCTV survey content, 24/7 availability messaging, and Google Business Profile optimisation as standard. From £250.
            </p>
            ...
            <div className="flex flex-wrap gap-6 mt-10">
              {['From £250', '24/7 emergency page', 'CCTV survey page', '6 months free hosting', 'Live in under 2 weeks'].map((t) => (
          ...
          <div className="max-w-2xl">
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                { name: 'Full', desc: '5+ pages — home, emergency, CCTV surveys, service areas, about', price: 'From £450' },
              ].map((pkg) => (
