...
const whatWeDo = [
  'Keyword research for "seo Shepton Mallet", "local seo Shepton Mallet" and every trade search in BA4',
  'Google Business Profile optimisation so you appear in the Map Pack for Shepton Mallet searches',
  'Website SEO: service pages, location pages and content that ranks in BA4',
...
const faqs = [
  {
    q: 'What does local SEO do for a Shepton Mallet business?',
    a: 'It gets you visible when people in Shepton Mallet, Frome, Wells and the surrounding BA4 area search for your trade or service on Google. That means showing up in the Map Pack — the three businesses with pins on Google Maps — and in the organic results below. Both drive real phone calls and enquiries.',
  },
  {
    q: 'How much does local SEO cost in Shepton Mallet?',
  ...
  },
  {
    ...
    a: "Google Business Profile optimisation can produce results within a few weeks. Ranking for competitive terms like 'plumber Shepton Mallet' or 'electrician BA4' typically takes 3–6 months. We give you monthly reports so you can see progress.",
  },
  {
    q: 'Is Shepton Mallet competitive for SEO?',
    a: 'Less competitive than Bath or Taunton — which works in your favour. Most Shepton Mallet trades have no website or a poorly optimised Google Business Profile, so the bar to rank is lower and results come faster.',
  },
  {
    q: 'Do I need a website as well as local SEO?',
    a: "You can do a lot with Google Business Profile alone, but a website makes every signal stronger. If you don't have one, we build fast, SEO-ready sites from £250 — and many Shepton Mallet clients do website and SEO together.",
  },
  {
    q: 'What areas near Shepton Mallet do you cover?',
    a: 'We cover Shepton Mallet and the surrounding BA4 area — including Frome, Wells, Glastonbury, Midsomer Norton, Radstock and the wider Somerset countryside.',
  },
];
...
const schema = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://seo-kings.co.uk/local-seo/shepton-mallet',
      url: 'https://seo-kings.co.uk/local-seo/shepton-mallet',
      name: 'Local SEO Shepton Mallet | Get in the Map Pack from £150/month',
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'Shepton Mallet' },
        ],
      },
    },
    {
      ...
      name: 'SEO Kings',
      description: 'Local SEO agency serving Shepton Mallet and BA4. Google Business Profile optimisation, website SEO and review growth for trades and local businesses across Shepton Mallet, Frome and Bath.',
      url: 'https://seo-kings.co.uk/local-seo/shepton-mallet',
  ...
  return (
    <>
      ...
      <ServicePageHero
        ...
        description="Shepton Mallet is a Somerset market town with strong demand for local trades — but most businesses here are invisible on Google. We change that. We get Shepton Mallet businesses into the Map Pack and page one for every relevant search in BA4."
        features={['From £150/month', 'Free audit included', 'Google Business Profile', 'Serving BA4']}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 leading-tight tracking-tight">
                Everything you need to rank in Shepton Mallet
              </h2>
              <p className="text-gray-400 leading-relaxed mb-8">
                Shepton Mallet has a loyal local customer base but most trades here are invisible on Google. A proper local SEO system — not a one-off tidy-up — is what separates the businesses that consistently win work from those that rely on word of mouth alone.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              SEO Kings is based in Keynsham — well placed to serve Shepton Mallet and the whole BA4 area. Shepton Mallet sits at the heart of Somerset — 17 miles from Bath, close to Frome and Wells — with a steady flow of local trade demand. Most of those trades have poor Google visibility, which means the opportunity to rank is genuinely strong.
            </p>
            <p className="text-gray-400 leading-relaxed mb-4">
              We cover Shepton Mallet and the surrounding area: Frome, Wells, Midsomer Norton, Radstock and the wider Somerset countryside. We target the exact postcodes your customers search from.
            </p>
            <p className="text-gray-400 leading-relaxed mb-8">
              Need a website too? We build fast, SEO-ready sites from £250. See our{' '}
              <Link href="/website-designer-shepton-mallet" className="underline hover:text-white transition-colors text-primary">website design Shepton Mallet</Link>{' '}
              page or{' '}
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-white mb-10 leading-tight tracking-tight">Common questions about local SEO in Shepton Mallet</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              <Link
                href="/website-designer-shepton-mallet"
                className="bg-dark-card border border-white/[0.06] rounded-2xl p-6 hover:border-white/10 transition-colors group"
              >
                <div className="text-white font-semibold text-sm mb-1">Website Designer Shepton Mallet</div>
                <div className="text-gray-400 text-xs">Fast, mobile-first websites for Shepton Mallet trades — from £250</div>
                <div className="mt-4 flex items-center gap-1 text-xs font-medium text-primary">
                  View page
                  <svg className="w-3 h-3 group-hover:translate-x-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              ...
              <Link
                href="/areas/shepton-mallet"
                className="bg-dark-card border border-white/[0.06] rounded-2xl p-6 hover:border-white/10 transition-colors group"
              >
                <div className="text-white font-semibold text-sm mb-1">Shepton Mallet Area Hub</div>
                <div className="text-gray-400 text-xs">All web design &amp; SEO services across Shepton Mallet and BA4</div>
                <div className="mt-4 flex items-center gap-1 text-xs font-medium text-primary">
                  View page
                  <svg className="w-3 h-3 group-hover:translate-x-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
...
export default LocalSEOSheptonMallet;
