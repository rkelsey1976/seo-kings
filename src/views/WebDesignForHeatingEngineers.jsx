  ...
  '@graph': [
    {
      ...
      description: 'Websites for heating engineers in Bath & Somerset. Fast, mobile-first, built to rank for emergency boiler repair and local search. Gas Safe badge display, dedicated service pages, Google Business Profile included. From £399.',
      inLanguage: 'en-GB',
    ...
    },
    {
      ...
      offers: {
        ...
        price: '399',
        priceCurrency: 'GBP',
        description: 'Heating engineer website from £399 including Google Business Profile set-up',
      },
    },
    {
      '@type': 'LocalBusiness',
...
const WebDesignForHeatingEngineers = () => {
  return (
    <>
      <SEO
        title="Web Design for Heating Engineers Bath & Somerset | From £399"
        description="Websites for heating engineers in Bath & Somerset. Fast, mobile-first, built for emergency boiler repair and local search. Gas Safe display, service pages, Google Business Profile included. From £399."
        canonical="/web-design-for/heating-engineers"
        breadcrumbs={[
          { name: 'Home', url: '/' },
          { name: 'Web Design for Heating Engineers' },
        ]}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6 leading-tight tracking-tight">
              Web Design for{' '}
              <span style={{ color: '#E8715A' }}>Heating Engineers</span>
              {' '}in Bath & Somerset
            </h1>
            ...
            <p className="text-lg text-gray-400 leading-relaxed max-w-2xl mb-8">
              We build websites for heating engineers in Bath, Keynsham, Midsomer Norton and across North East Somerset — with Gas Safe badge on every page, dedicated emergency boiler repair page, and Google Business Profile optimisation as standard. From £399.
            </p>
            ...
            <div className="flex flex-wrap gap-6 mt-10">
              {['From £399', 'Gas Safe badge on every page', 'Emergency boiler repair page', '6 months free hosting', 'Live in under 2 weeks'].map((t) => (
      ...
      <section className="py-20 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-6">Why most heating engineer websites don't generate calls</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl font-bold text-white mb-6">Built specifically for heating engineering businesses</h2>
          ...
          <div className="max-w-2xl">
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                { name: 'Full', desc: '5+ pages — home, emergency boiler repair, service pages, service areas, about', price: 'From £999' },
              ].map((pkg) => (
      ...
      <section className="py-20 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-6">We know the Bath & Somerset heating engineer market</h2>
            <p className="text-gray-400 leading-relaxed mb-4">
      ...
      <section className="py-20 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-white mb-10">Common questions about heating engineer websites</h2>
