...
const faqs = [
  {
    q: "What's the best starting point for a Melksham business?",
    a: "Most Melksham trades do best starting with a website and Google Business Profile together. SN12 is less competitive than Bath — your investment goes further and results come faster. We'll tell you exactly what to prioritise in your free audit.",
  },
  {
    q: 'Can I rank in Bath and Trowbridge as well as Melksham?',
    a: 'Yes — many Melksham traders serve the whole Wiltshire and Somerset corridor. We structure your site and GBP to target multiple towns, so one plan covers your whole working area without extra cost.',
  },
  {
    q: 'How competitive is Melksham for local search?',
    a: 'Less competitive than Bath. Most Melksham trades have no website or a weak Google Business Profile — the bar to reach page one is lower here, and results come faster.',
  },
  {
    q: 'How long before I see results?',
    a: "GBP improvements can show within weeks. Organic rankings for Melksham trade searches typically take 2–4 months. You'll get a monthly report so you can see exactly what's moving.",
  },
  {
    q: 'What does it cost?',
  ...
  '@graph': [
    {
      ...
      name: 'Digital Marketing in Melksham | SEO & Local Search | SEO Kings',
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Melksham' },
        ],
      },
    },
    {
      ...
      name: 'SEO Kings',
      description: 'Web design, local SEO and Google Business Profile agency serving Melksham SN12 and the surrounding Wiltshire area. Fast, mobile-first websites from £250 and local SEO from £150/month for trades and local businesses across Melksham, Trowbridge, Chippenham and Bath.',
      url: 'https://seo-kings.co.uk/areas/melksham',
    ...
    <>
      ...
      <section className="py-24 bg-dark-lighter border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <SectionTag className="mb-4">Our services in Melksham</SectionTag>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 leading-tight tracking-tight">
              Everything you need to get found in Melksham
            </h2>
            <p className="text-gray-400 leading-relaxed max-w-2xl">
              Melksham&apos;s residential growth means demand for local services is rising — but most local trades still have poor Google visibility. Three services, one team — website, local SEO and GBP all working together.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    ...
                    'Built to rank for your trade + Melksham searches',
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Melksham has far less competition than Bath. The businesses in the map pack take most of the calls — and getting there is more achievable here. We get you in and keep you there.
              </p>
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    'Google Business Profile optimisation',
                    'On-page SEO for Melksham trade keywords',
              ...
              <div className="mt-auto">
                <Link
                  href="/local-seo/melksham"
                  className="block w-full text-center px-6 py-3 rounded-lg font-semibold text-white transition-all duration-200 bg-primary-dark"
                >
                  Local SEO in Melksham →
                </Link>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              We&apos;re based in Keynsham — well placed to serve Melksham and the whole SN12 area. Melksham has seen significant residential and commercial growth in recent years: new housing developments, more families, more demand for local trades. Most of those trades have poor Google visibility — and that&apos;s a real opportunity.
            </p>
            <p className="text-gray-400 leading-relaxed mb-8">
              We cover Melksham and the surrounding area: Trowbridge, Chippenham, Bradford on Avon, Devizes and Bath. Many Melksham clients also want to rank across the wider Wiltshire corridor — we structure everything to cover your whole working area.
            </p>
            <a
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-white mb-10 leading-tight tracking-tight">Common questions about our Melksham services</h2>
