...
const faqs = [
  {
    q: "What's the best starting point for a Paulton business?",
    a: "For most trades, a website and Google Business Profile together give the strongest start. Paulton is a less competitive market than Bath or Bristol — your budget goes further here and results typically come faster. We'll tell you what to prioritise in your free audit.",
  },
  {
    q: 'Can I rank in Midsomer Norton and Bath as well as Paulton?',
    a: "Yes — many Somer Valley trades serve a wide area. We structure your site and GBP to target Paulton, Midsomer Norton and Bath from one plan, so you're visible across your whole working area without extra cost.",
  },
  {
    q: 'How competitive is Paulton for local search?',
    a: "Less competitive than Bath or Bristol. Many trades in BS39 still have no website or a poorly optimised Google Business Profile — the bar to get on page one is lower, and results come sooner.",
  },
  {
    q: 'How long before I see results?',
    a: "GBP improvements can show within weeks. Organic rankings for Paulton trade searches typically take 2–4 months. You'll get a monthly report so you see exactly what's moving.",
  },
  {
    q: 'What does it cost?',
...
const schema = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://seo-kings.co.uk/areas/paulton',
      url: 'https://seo-kings.co.uk/areas/paulton',
      name: 'Web Design & SEO in Paulton | Somer Valley Trades | SEO Kings',
    ...
    },
    {
      ...
      name: 'SEO Kings',
      description: 'Web design, local SEO and Google Business Profile agency serving Paulton BS39 and the Somer Valley. Fast, mobile-first websites from £250 and local SEO from £150/month for trades and local businesses across Paulton, Midsomer Norton and Bath.',
      url: 'https://seo-kings.co.uk/areas/paulton',
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: 'url(/images/areas/paulton.webp)',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6 leading-tight tracking-tight">
              Web Design &amp; SEO in{' '}
              <span className="text-primary">Paulton</span>
            </h1>
            <p className="text-xl text-gray-400 leading-relaxed max-w-2xl mb-4">
              One team. Three services. All focused on getting your Paulton business found on Google.
            </p>
            <p className="text-base text-gray-400 leading-relaxed max-w-2xl mb-8">
              Paulton is a Somer Valley market town — less competitive than Bath or Bristol, which means the right strategy gets you visible fast. Whether you need a website, local SEO, or both, we build everything around getting you found in BS39 and the surrounding Somer Valley.
            </p>
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <SectionTag className="mb-4">Our services in Paulton</SectionTag>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 leading-tight tracking-tight">
              Everything you need to get found in Paulton
            </h2>
            <p className="text-gray-400 leading-relaxed max-w-2xl">
              Three services, one team, clear monthly pricing. Most Paulton clients combine website design and local SEO — and see results faster here than in Bath or Bristol.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Fast, mobile-first websites for Paulton trades and local businesses — built for local search from day one, not as an afterthought.
              </p>
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    'Mobile-first design, loads fast on any device',
                    'Built to rank for your trade + Paulton searches',
              ...
              <div className="mt-auto">
                ...
                >
                  Website Design for Paulton Businesses →
                </Link>
              </div>
            </div>
              ...
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    ...
                    'On-page SEO for Paulton trade keywords',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              We're based in Keynsham — a short drive from Paulton. We understand the Somer Valley market: which trade searches drive enquiries in BS39, how to rank in Paulton while also targeting Midsomer Norton and Bath.
            </p>
            <p className="text-gray-400 leading-relaxed mb-8">
              Sub-areas covered: High Littleton, Hallatrow, Farrington Gurney, Timsbury, and the wider BS39 postcode.
            </p>
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-white mb-10 leading-tight tracking-tight">Common questions about our Paulton services</h2>
