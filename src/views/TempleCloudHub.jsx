...
const schema = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      name: 'SEO Kings',
      description: 'Web design, local SEO and Google Business Profile agency serving Temple Cloud BS39 and the surrounding area. Fast, mobile-first websites from £250 and local SEO from £150/month for trades and local businesses across Temple Cloud, Bath and Bristol.',
      url: 'https://seo-kings.co.uk/areas/temple-cloud',
