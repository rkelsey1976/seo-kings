...
const faqs = [
  {
    q: "What's the best starting point for a Temple Cloud business?",
    a: "For most trades, a website and Google Business Profile together give the strongest foundation. Temple Cloud is a very low-competition market — much easier than Bath or Bristol — so the right strategy gets you visible fast. We'll tell you what to prioritise in your free audit.",
  },
  {
    q: 'Can I rank in Bath and Bristol as well as Temple Cloud?',
    a: "Yes — most Temple Cloud trades serve a wide area. We structure your site and GBP to target multiple locations from one plan, so you're visible wherever your customers are searching.",
  },
  {
    q: 'How competitive is Temple Cloud for local search?',
  ...
  },
  {
    ...
    a: "GBP improvements can show within weeks. Organic rankings for Temple Cloud trade searches typically take 2–4 months. You'll get a monthly report showing exactly what's moving.",
  },
  {
    q: 'What does it cost?',
...
const schema = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://seo-kings.co.uk/areas/temple-cloud',
      url: 'https://seo-kings.co.uk/areas/temple-cloud',
      name: 'Web Design & SEO in Temple Cloud | BS39 Trades & Businesses | SEO Kings',
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Temple Cloud' },
        ],
      },
    },
    {
      ...
      name: 'SEO Kings',
      description: 'Web design, local SEO and Google Business Profile agency serving Temple Cloud BS39 and the surrounding area. Fast, mobile-first websites from £399 and local SEO from £150/month for trades and local businesses across Temple Cloud, Bath and Bristol.',
      url: 'https://seo-kings.co.uk/areas/temple-cloud',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6 leading-tight tracking-tight">
              Web Design &amp; SEO in{' '}
              <span style={{ color: '#E8715A' }}>Temple Cloud</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <p className="text-[11px] font-mono font-medium tracking-[0.12em] uppercase mb-4" style={{ color: '#E8715A' }}>
              Our services in Temple Cloud
            </p>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 leading-tight">
              Everything you need to get found in Temple Cloud
            </h2>
            <p className="text-gray-400 leading-relaxed max-w-2xl">
              Three services, one team, clear monthly pricing. Most Temple Cloud clients combine website design and local SEO — and see results faster here than in Bath or Bristol.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Fast, mobile-first websites for Temple Cloud trades and local businesses — built for local search from day one, not as an afterthought.
              </p>
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    'Mobile-first design, loads fast on any device',
                    'Built to rank for your trade + Temple Cloud searches',
              ...
              <div className="mt-auto">
                <Link
                  ...
                  style={{ backgroundColor: '#C25245' }}
                >
                  Website Design for Temple Cloud Businesses →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Temple Cloud has very low competition compared to Bath or Bristol. The businesses in the map pack take most of the calls — and getting there is much more achievable here. We get you in and keep you there.
              </p>
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    'Google Business Profile optimisation',
                    'On-page SEO for Temple Cloud trade keywords',
      ...
      <section className="py-20 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-6">We know the A37 corridor</h2>
            <p className="text-gray-400 leading-relaxed mb-4">
              We&apos;re based in Keynsham — well placed to serve Temple Cloud and the surrounding villages. Temple Cloud sits on the A37 between Bath and Bristol, and most local trades serve a wide area. We know which searches drive enquiries here and how to build visibility across Bath, Bristol and the Somer Valley from a single plan.
            </p>
      ...
      <section className="py-20 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-10">Common questions about our Temple Cloud services</h2>
