...
const included = [
  ...
  'Built to rank for Frome, Shepton Mallet and Somerset trade searches',
  'Google Business Profile set-up — competition in BA11 is low, Map Pack rankings come quickly',
...
const faqs = [
  {
    q: 'How much does a website cost in Frome?',
  ...
  {
    q: 'Do you work with businesses in Frome?',
    a: "Yes. We're based in Keynsham and work with businesses across Frome, Shepton Mallet, Radstock, Midsomer Norton and the surrounding Somerset area.",
  },
  {
  ...
  {
    q: 'Will my website show up on Google in Frome?',
    a: "Yes — that's the point. Every site we build is optimised for local search from day one, targeting the searches your customers in Frome and BA11 actually use.",
  },
  {
    q: 'What trades do you work with in Frome?',
    a: 'Plumbers, electricians, builders, cleaners, painters — any trade that needs local customers in Frome, Shepton Mallet or the wider Somerset area.',
  },
];
...
const schema = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://seo-kings.co.uk/website-designer-frome',
      url: 'https://seo-kings.co.uk/website-designer-frome',
      name: 'Website Designer Frome | Web Design from £250',
    ...
    },
    {
      ...
      name: 'SEO Kings',
      description: 'Website designer serving Frome and the BA11 area — web design from £250 for trades and local businesses across Frome, Shepton Mallet, Radstock and Bath.',
      url: 'https://seo-kings.co.uk/website-designer-frome',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6 leading-tight tracking-tight">
              Website Designer{' '}
              <span className="text-primary">Frome</span>
            </h1>
            <p className="text-xl text-gray-400 leading-relaxed max-w-2xl mb-8">
              We build fast, Google-ready websites for trades and local businesses in Frome BA11. From £250. Add GBP optimisation for £100. Live in under 2 weeks.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 leading-tight tracking-tight">
                A website built to get you found in Frome
              </h2>
              <p className="text-gray-400 leading-relaxed mb-8">
                Most website designers build pretty sites that don&apos;t rank. Every site we build is optimised for Google from the start — targeting the searches customers in Frome and the surrounding Somerset area actually use.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-gray-400 leading-relaxed mb-4">
              SEO Kings is based in Keynsham — well placed to serve Frome and the whole BA11 area. Frome&apos;s creative, independent business scene means there&apos;s real demand for trades — and most of them are invisible on Google. BA11 is one of the least contested markets we work in.
            </p>
            <p className="text-gray-400 leading-relaxed mb-8">
              We serve businesses across Frome and the surrounding area: Shepton Mallet, Westbury, Midsomer Norton, Radstock and the wider Somerset and Wiltshire border. If you&apos;re a trade in Frome without a website, you&apos;re leaving calls on the table every week.
            </p>
            <a
              href="tel:+447702264921"
...
export default WebsiteDesignerFrome;
