  ...
  '@graph': [
    {
      ...
      description: 'Websites for kitchen fitters in Bath & Somerset. Fast, mobile-first, built to rank for local search. Project galleries, before/after photos, FMB badge display, dedicated service pages. From £250. Add GBP optimisation for £100.',
      inLanguage: 'en-GB',
    ...
    },
    {
      ...
      offers: {
        ...
        price: '250',
        priceCurrency: 'GBP',
        description: 'Kitchen fitter website from £250 — GBP optimisation available as a £100 add-on',
      },
    },
    {
      '@type': 'LocalBusiness',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-gray-400 leading-relaxed max-w-2xl mb-8">
              We build websites for kitchen fitters in Bath, Keynsham, Midsomer Norton and across North East Somerset — with project galleries, before/after photos, FMB and Trustatrader badge display, dedicated service pages, from £250. Add GBP optimisation for £100.
            </p>
