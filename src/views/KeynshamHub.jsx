...
const heroFeatures = ['Websites from £250', 'Local SEO from £150/month', 'Based in Keynsham', 'Free audit — no obligation'];
...
const KeynshamHub = () => {
  return (
    <>
      <SEO
        title="SEO & Web Design in Keynsham BS31 | Trades & Local Businesses"
        description="Web design, local SEO and Google Business Profile for trades and local businesses in Keynsham BS31. Websites from £250, local SEO from £150/month. Free audit — no obligation."
      ...
      <ServicePageHero
        ...
        highlight="Keynsham"
        description="One team. Three services. All focused on getting your Keynsham business found on Google. Less competitive than Bath or Bristol — the right strategy gets you visible fast."
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Fast, mobile-first websites for Keynsham trades and local businesses. See the full website design page for packages and pricing.
              </p>
