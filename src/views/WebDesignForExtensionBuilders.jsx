  ...
  '@graph': [
    {
      ...
      description: 'Websites for extension builders in Bath & Somerset. Fast, mobile-first, built to rank for extension searches. Conservation area expertise, Bath stone, before/after galleries, Google Business Profile included. From £250.',
      inLanguage: 'en-GB',
    ...
    },
    {
      ...
      offers: {
        ...
        price: '399',
        priceCurrency: 'GBP',
        description: 'Extension builder website from £250 including Google Business Profile set-up',
      },
    },
    {
      '@type': 'LocalBusiness',
  ...
  return (
    <>
      <SEO
        ...
        description="Websites for extension builders in Bath & Somerset. Fast, mobile-first, built for extension searches. Conservation area expertise, Bath stone, before/after galleries, Google Business Profile included. From £250."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6 leading-tight tracking-tight">
              Web Design for{' '}
              <span className="text-primary">Extension Builders</span>
              {' '}in Bath & Somerset
            </h1>
            ...
            <p className="text-lg text-gray-400 leading-relaxed max-w-2xl mb-8">
              We build websites for extension builders in Bath, Keynsham, Midsomer Norton and across North East Somerset — with conservation area expertise, before and after galleries, and Google Business Profile optimisation as standard. From £250.
            </p>
            ...
            <div className="flex flex-wrap gap-6 mt-10">
              {['From £250', 'Conservation area expertise', 'Before & after gallery', '6 months free hosting', 'Live in under 2 weeks'].map((t) => (
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-6 leading-tight tracking-tight">Why most extension builder websites do not generate enquiries</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl font-bold text-white mb-6 leading-tight tracking-tight">Built specifically for extension builders</h2>
          ...
          <div className="max-w-2xl">
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                { name: 'Professional', desc: '3-page site — home, 1 extension type page, contact', price: 'From £350' },
                { name: 'Full', desc: '5+ pages — home, extension type pages, gallery, planning guide, about', price: 'From £450' },
              ].map((pkg) => (
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-6 leading-tight tracking-tight">We know the Bath & Somerset extension market</h2>
            <p className="text-gray-400 leading-relaxed mb-4">
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-white mb-10 leading-tight tracking-tight">Common questions about extension builder websites</h2>
