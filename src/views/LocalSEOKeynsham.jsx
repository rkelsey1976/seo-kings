      ...
      <section className="py-20 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-400 leading-relaxed mb-8">
              Need a website too? We build fast, Google-ready sites from £399. Many Keynsham clients do website and SEO together — one team, one plan. See our <Link href="/website-designer-keynsham" className="underline hover:text-white transition-colors" style={{ color: '#E8715A' }}>website design Keynsham</Link> page for details.
            </p>
      ...
      <section className="py-20 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-10">Common questions about local SEO in Keynsham</h2>
