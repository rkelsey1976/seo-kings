...
const caseStudiesData = {
  ...
  'bath-painter': {
    ...
    logo: 'BP',
    tagline: 'Bespoke website in build for a Bath heritage property specialist',
    ...
    solution: [
      ...
      'Google Business Profile setup and optimisation planned post-launch',
    ...
    testimonial: {
      quote: 'Site currently in build — testimonial coming soon.',
      author: 'Bath Painter',
