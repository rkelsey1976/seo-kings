        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <nav className="mb-8" aria-label="Breadcrumb">
            <ol className="flex flex-wrap items-center gap-2 text-sm text-gray-400">
              ...
              <li aria-hidden="true">/</li>
              <li className="text-white">Radstock</li>
            </ol>
          </nav>
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-400 leading-relaxed max-w-2xl mb-8">
              When someone in Radstock searches for your trade or service, are you the first result they see? We help businesses across BA3 and the Somer Valley rank in the Map Pack and the organic results — so you get more calls and more work.
            </p>
      ...
      <section className="py-20 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-10">Common questions about local SEO in Radstock</h2>
