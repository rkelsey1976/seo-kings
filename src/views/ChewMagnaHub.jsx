...
const ChewMagnaHub = () => {
  return (
    <>
      <SEO
        title="Web Design & SEO in Chew Magna | Chew Valley Trades | SEO Kings"
        description="Web design, local SEO and Google Business Profile for trades and local businesses in Chew Magna BS40. Websites from £399, local SEO from £150/month. Free audit — no obligation."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6 leading-tight tracking-tight">
              Web Design &amp; SEO in{' '}
              <span style={{ color: '#E8715A' }}>Chew Magna</span>
            </h1>
      ...
      <section className="py-20 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-6">We know the Chew Valley</h2>
      ...
      <section className="py-20 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold text-white mb-10">Common questions about our Chew Magna services</h2>
