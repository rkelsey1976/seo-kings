...
const faqs = [
  {
    q: "What's the best starting point for a Chew Magna business?",
    a: "For most trades, a website and Google Business Profile together give you the strongest start. Chew Magna is a less competitive market than Bath or Bristol — your investment goes further and results come faster. We'll tell you what to prioritise in your free audit.",
  },
  {
    q: 'Can I rank in Bath and Bristol as well as Chew Magna?',
    a: "Yes — most Chew Valley trades serve a wide area including Bath and Bristol. We structure your site and GBP to target multiple locations from one plan, so you're visible across your whole working area.",
  },
  {
    q: 'How competitive is Chew Magna for local search?',
    a: "Much less competitive than Bath or Bristol. Many Chew Valley trades still have no website or a weak Google Business Profile — the bar to get on page one is low and results come quickly.",
  },
  {
    q: 'How long before I see results?',
    a: "GBP improvements can show within weeks. Organic rankings for Chew Magna trade searches typically take 2–4 months. You'll get a monthly report showing exactly what's moving.",
  },
  {
    q: 'What does it cost?',
...
const schema = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://seo-kings.co.uk/areas/chew-magna',
      url: 'https://seo-kings.co.uk/areas/chew-magna',
      name: 'Web Design & SEO in Chew Magna | Chew Valley Trades | SEO Kings',
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: 'Chew Magna' },
        ],
      },
    },
    {
      ...
      name: 'SEO Kings',
      description: 'Web design, local SEO and Google Business Profile agency serving Chew Magna BS40 and the Chew Valley. Fast, mobile-first websites from £250 and local SEO from £150/month for trades and local businesses across Chew Magna, Bath and Bristol.',
      url: 'https://seo-kings.co.uk/areas/chew-magna',
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: 'url(/images/areas/chew-magna.webp)',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6 leading-tight tracking-tight">
              Web Design &amp; SEO in{' '}
              <span className="text-primary">Chew Magna</span>
            </h1>
            <p className="text-xl text-gray-400 leading-relaxed max-w-2xl mb-4">
              One team. Three services. All focused on getting your Chew Magna business found on Google.
            </p>
            <p className="text-base text-gray-400 leading-relaxed max-w-2xl mb-8">
              The Chew Valley is an affluent, rural market between Bath and Bristol — less competitive than either city, which means the right strategy gets you visible fast. Whether you need a website, local SEO, or both, we build everything around getting you found across BS40 and the surrounding area.
            </p>
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <SectionTag className="mb-4">Our services in Chew Magna</SectionTag>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 leading-tight tracking-tight">
              Everything you need to get found in Chew Magna
            </h2>
            <p className="text-gray-400 leading-relaxed max-w-2xl">
              Three services, one team, clear monthly pricing. Most Chew Valley clients combine website design and local SEO — and see results faster here than in Bath or Bristol.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Fast, mobile-first websites for Chew Magna trades and local businesses — built for local search from day one, not as an afterthought.
              </p>
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    'Mobile-first design, loads fast on any device',
                    'Built to rank for your trade + Chew Magna searches',
              ...
              <div className="mt-auto">
                ...
                >
                  Website Design for Chew Magna Businesses →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-dark-card border border-white/[0.06] rounded-2xl p-8 flex flex-col">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                The Chew Valley has far less competition than Bath or Bristol. The businesses in the map pack take most of the calls — and getting there is more achievable here. We get you in and keep you there.
              </p>
              <div className="border-t border-white/[0.06] pt-6 mb-6">
                <ul className="space-y-3">
                  {[
                    'Google Business Profile optimisation',
                    'On-page SEO for Chew Magna trade keywords',
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-white mb-6 leading-tight tracking-tight">We know the Chew Valley</h2>
            <p className="text-gray-400 leading-relaxed mb-4">
              We&apos;re based in Keynsham — a short drive from Chew Magna. The Chew Valley is an affluent, rural area where trades serve customers across Bath, Bristol and the surrounding villages. We know which searches drive enquiries here, and how to build visibility across the whole valley from a single plan.
            </p>
            <p className="text-gray-400 leading-relaxed mb-8">
              We cover the whole of the Chew Valley — Chew Stoke, Bishop Sutton, Stanton Drew, Pensford, West Harptree, and the wider BS40 postcode. Many Chew Magna clients also want to rank in Bath and Bristol — we can target multiple locations from one plan.
            </p>
      ...
      <section className="py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-white mb-10 leading-tight tracking-tight">Common questions about our Chew Magna services</h2>
