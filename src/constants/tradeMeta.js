export const TRADE_META = {
  ...
  landscapers: {
    name: 'Landscapers',
    metaTitle: 'Landscaper SEO — Bristol & Bath Map Pack from £150/mo',
    metaDescription: 'Someone near you is searching for a landscaper right now. We get Bristol and Bath landscapers into the Map Pack top 3. From £150/month, no lock-in.',
    faqs: [
