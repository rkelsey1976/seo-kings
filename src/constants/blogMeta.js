 ...
 * Keep in sync with title/description in src/pages/BlogPost.jsx when changing posts.
 */
export const BLOG_META = {
  // ── KEEP — no competing landing page, genuine informational value ──────────
  ...
  // ── NOINDEX ONLY — informational content worth keeping, stop competing ─────
  'gbp-trades-losing-customers': {
    ...
    canonical: 'https://seo-kings.co.uk/google-business-profile',
  ...
  'seo-for-plumbers-bath': {
    ...
    canonical: 'https://seo-kings.co.uk/local-seo/plumbers',
    robots: 'noindex, follow',
  },
  ...
  'keynsham-gbp-keyword-research': {
    ...
    canonical: 'https://seo-kings.co.uk/areas/keynsham',
    robots: 'noindex, follow',
  },
  ...
  'one-page-website-bath-banes': {
    ...
    canonical: 'https://seo-kings.co.uk/web-design-packages',
    robots: 'noindex, follow',
  },

  // ── REDIRECT — thin location posts, same commercial intent as landing page ─
  ...
  'website-design-radstock': {
    ...
    canonical: 'https://seo-kings.co.uk/website-designer-radstock',
    robots: 'noindex, follow',
  },
  'website-design-peasedown-st-john': {
    ...
    canonical: 'https://seo-kings.co.uk/website-designer-peasedown-st-john',
    robots: 'noindex, follow',
  },
  'website-design-somer-valley': {
    ...
    canonical: 'https://seo-kings.co.uk/areas/midsomer-norton',
    robots: 'noindex, follow',
  },
  'website-design-trowbridge': {
    ...
    canonical: 'https://seo-kings.co.uk/website-designer-trowbridge',
    robots: 'noindex, follow',
  },
};
