/**
 * Google reviews / client quotes for the Reviews section.
 * Add your real Google review text here — use { quote, name, business, location?, stars: 5 }.
 */
...
export const REVIEWS = [
  {
    ...
    location: 'Painter & Decorator, Bath & BANES',
    stars: 5,
  },
  {
