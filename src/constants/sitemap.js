...
export const STATIC_ROUTES = [
  ...
  { path: '/website-designer-peasedown-st-john', lastmod: '2026-05-30', changefreq: 'monthly', priority: 0.9 },
  ...
  { path: '/local-seo/saltford', lastmod: '2026-05-30', changefreq: 'monthly', priority: 0.9 },
