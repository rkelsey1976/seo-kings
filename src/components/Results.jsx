      ...
      <div className="grid md:grid-cols-3 gap-4 mb-4">
        {caseStudies.map((study, i) => (
          ...
          >
            ...
            <Tag>{study.trade}</Tag>
            <div className="text-white font-semibold text-sm mb-0.5" style={{ letterSpacing: '-0.01em' }}>{study.business}</div>
            <div className="font-mono text-[10px] mb-3" style={{ color: 'rgba(255,255,255,0.3)', letterSpacing: '0.06em' }}>{study.location}</div>
            ...
            <div className="font-mono text-[10px] mb-2" style={{ color: 'rgba(255,255,255,0.4)', letterSpacing: '0.06em' }}>
              Maps clicks · {study.gbpPeriod}
            </div>
            <div className="font-mono text-[10px] mb-1" style={{ color: '#6EE7A0' }}>{study.gbpPeak}</div>
            <div className="font-mono text-[9px]" style={{ color: 'rgba(255,255,255,0.25)' }}>{study.footnote}</div>
