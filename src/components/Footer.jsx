        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3">
              <a href="tel:01225123456" className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors">
                <svg className="w-5 h-5 text-primary" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                01225 123 456
              </a>
              <a href="mailto:hello@seokings.co.uk" className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors">
                <svg className="w-5 h-5 text-primary" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                  <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                </svg>
                hello@seokings.co.uk
              </a>
            </div>
          </div>
          ...
          {/* Areas Column */}
          <div>
            <p className="text-white font-semibold mb-6">Areas We Serve</p>
            <ul className="space-y-3">
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-4" role="list" aria-label="Social media links">
                <a
                  ...
                  className="w-10 h-10 bg-white/5 hover:bg-white/10 rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-all focus:outline-none focus:ring-2 focus:ring-primary"
                >
