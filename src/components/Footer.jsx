        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 lg:gap-12 pb-8 sm:pb-12 border-b border-white/5">
          ...
          <div className="flex flex-col sm:flex-row gap-6 sm:gap-10">
            ...
            <div className="space-y-3">
              ...
              <address className="not-italic flex items-start gap-3 text-gray-300 text-sm sm:text-base">
                <svg className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0zM15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <a href={GOOGLE_MAPS_PLACE_URL} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="View SEO Kings address on Google Maps">
                  16a Culvers Road<br />
