  ...
  const caseStudies = [
    {
      ...
      results: [
        ...
        { metric: '47', label: 'New 5-star reviews' },
      ],
      timeframe: '4 months',
    ...
    },
    {
      ...
      imageAlt: 'Roofer working on roof in Midsomer Norton - Google Business Profile optimisation case study with 47 new reviews',
      ...
      results: [
        { metric: '0→47', label: 'Google reviews gained' },
