  ...
  '@graph': [
    {
      ...
      description: 'Website designer serving Radstock BA3. Fast, mobile-first websites for trades and local businesses from £399. Google Business Profile included.',
      inLanguage: 'en-GB',
    ...
    },
    {
      ...
      name: 'SEO Kings',
      description: 'Website designer serving Radstock and the Somer Valley — web design from £399 for trades and local businesses across BA3, Bath and North East Somerset.',
      url: 'https://seo-kings.co.uk/website-designer-radstock',
...
const WebsiteDesignerRadstock = () => {
  return (
    <>
      <SEO
        title="Website Designer Radstock | Web Design from £399 | SEO Kings"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-400 leading-relaxed max-w-2xl mb-8">
              We build fast, Google-ready websites for trades and local businesses in Radstock BA3. From £399 — with Google Business Profile set-up included. Live in under 2 weeks.
            </p>
