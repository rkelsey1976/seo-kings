...
const AreaDetail = ({ params: staticParams }) => {
  ...
  const areasData = {
    ...
    'midsomer-norton': {
      ...
      postcodes: ['BA3'],
      population: '11,000+',
      heroImage: '/images/areas/midsomer-norton.jpg',
    ...
    'radstock': {
      ...
      gallery: [
        { src: '/images/areas/radstock.jpg', alt: 'St Nicholas Church, Radstock', caption: 'St Nicholas Church, Radstock' },
    ...
    'peasedown-st-john': {
      ...
      postcodes: ['BA2'],
      population: '6,500+',
      heroImage: '/images/areas/peasedown-st-john.jpg',
    ...
    'paulton': {
      ...
      postcodes: ['BS39'],
      population: '5,300+',
      heroImage: '/images/areas/paulton.jpg',
    ...
    'saltford': {
      ...
      gallery: [
        ...
        { src: '/images/areas/saltford-marina.jpg', alt: 'Saltford Marina', caption: 'Saltford Marina' },
    ...
    'timsbury': {
      ...
      postcodes: ['BA2'],
      population: '2,600+',
      heroImage: '/images/areas/timsbury.jpg',
    ...
    'westfield': {
      ...
      postcodes: ['BA3'],
      population: '2,000+',
      heroImage: '/images/areas/westfield.jpg',
    ...
    'chew-magna': {
      ...
      postcodes: ['BS40'],
      population: '1,200+',
      heroImage: '/images/areas/chew-magna.jpg',
    ...
    'temple-cloud': {
      ...
      postcodes: ['BS39'],
      population: '1,500+',
      heroImage: '/images/areas/temple-cloud.jpg',
    ...
    'clutton': {
      ...
      postcodes: ['BS39'],
      population: '1,800+',
      heroImage: '/images/areas/clutton.jpg',
    ...
    'odd-down-bath': {
      ...
      postcodes: ['BA2'],
      population: null,
      heroImage: '/images/areas/bath-roman-baths.jpg',
    ...
    'bitton-keynsham': {
      ...
      county: 'Bristol',
      postcodes: ['BS30', 'BS31'],
      heroImage: '/images/areas/keynsham-health-centre.jpg',
    ...
    'writhlington-radstock': {
      ...
      county: 'Somerset',
      postcodes: ['BA3'],
      heroImage: '/images/areas/radstock.jpg',
